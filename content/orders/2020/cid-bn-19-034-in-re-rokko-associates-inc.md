---
title: "CID BN 19-034: In re: Rokko and Associates, Inc."
description: "Order closing CID BN 19-034 after Hexel Works, Inc. (formerly Rokko and Associates, Inc.) submitted a complete post-breach report that fully complied with the Commission's orders, including individual notification of all 158 affected data subjects prior to receiving the Commission's grant of mass email notification."
aliases:
  - "CID BN 19-034"
  - "cid bn 19-034"
  - "In re: Rokko and Associates, Inc."
  - "in re: rokko and associates, inc."
tags:
  - "order"
  - "type/order"
...
## Source
- Reference: CID BN 19-034
- Official PDF: http://privacy.gov.ph/wp-content/uploads/2023/05/CID-BN-19-034-In-re-ROKKO-Associates-Inc-Order-2020.09.22.pdf
- Source page: http://privacy.gov.ph/orders-2/
- Issue date: September 21, 2020
- Pages: 5

## Source Tags
- Content of the Data Breach Notification Report
- Notification to the Commission

## Order Text

IN RE: ROKKO AND ASSOCIATES, INC.                     CID BN 19-034

x----------------------------------------------------x

**ORDER**

Before this Commission is a complete post breach report submitted by Hexel Works, Inc. (formerly Rokko and Associates, Inc.), through The Law Firm of Ingles Laurel Calderon dated 28 July 2020.
...
In order to secure or recover the data compromised, Hexel has duplicated the data stored on both laptops through the company server, as the original database was secured and stored in such server, before both laptops went missing.

As to the notification of data subjects, Hexel also complied with the requirements of Section 18 of NPC Circular 16-03. An affidavit of compliance was executed by Hexel's legal counsel, who also attached therein the copy of the apology letter and notification of breach.
...
WHEREFORE, all premises considered, the Commission resolves that the matter CID BN 19-034 — "In Re: Rokko and Associates, Inc." is hereby considered **CLOSED.**
