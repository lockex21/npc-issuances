---
title: "CID BN 17-021: In re: Sun Life of Canada (Philippines), Inc."
description: "Show cause order directing Sun Life of Canada (Philippines), Inc. to explain in writing within fifteen days why it should not be held liable for Failure to Notify under NPC Circular 16-03, after the Commission found that Sun Life unreasonably delayed notification of affected data subjects despite the denial of its second request for reconsideration."
aliases:
  - "CID BN 17-021"
  - "cid bn 17-021"
...
- Official PDF: http://privacy.gov.ph/wp-content/uploads/2024/08/CID-BN-17-021-2020.07.23-In-Re-BN-Report-of-Sun-Life-of-Canada-Order.pdf
...
- Exemption from Notification of Data Subjects

## Order Text

IN RE: BREACH NOTIFICATION REPORT OF SUNLIFE OF CANADA                     CID BN 17-021
...
2. There is no risk of serious harm to the affected data subjects because of the following:
   ...
   - b. The nature of data exposed are low risk and are not used in the client validation process across all channels of Sun Life;[^1] and
...
> Section 20. Failure to Notify. In case the personal information controller fails to notify the Commission or data subjects, or there is unreasonable delay to notification, the Commission shall determine if such failure is justified. xxx[^3]
