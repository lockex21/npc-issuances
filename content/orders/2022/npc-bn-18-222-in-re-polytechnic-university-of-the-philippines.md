...
description: "Order directing the Polytechnic University of the Philippines to individually notify its 991 affected Student Information System users and submit proof of security measures, after finding that its SIS notification prompt did not meet the content and form requirements of Section 18 of NPC Circular No. 16-03."
aliases:
  - "NPC BN 18-222"
  - "npc bn 18-222"
...
- Official PDF: http://privacy.gov.ph/wp-content/uploads/2024/08/NPC-BN-18-222-2022.11.10-In-Re-Polytechnic-University-of-the-Philippines-Order.pdf
...
IN RE: POLYTECHNIC UNIVERSITY OF THE PHILIPPINES                                              NPC BN 18-222

x----------------------------------------------------x

**ORDER**

Before the Commission is the Compliance submitted by Polytechnic University of the Philippines (PUP) dated 03 June 2022[^1] in fulfillment of the Commission's directive in its Order dated 20 May 2022.[^2]

In its letter dated 22 November 2018, the PUP notified the Commission of a breach in its information security.[^3] It alleged that on 20 November 2018, it came across a post dated 18 November 2018 on the Facebook page of ZeroSecurity PH claiming that the latter was able to get three thousand eight hundred nine (3,809) emails from #PUPWebsite and #HalfofDatabaseEmails.[^4] After seeing the post, the PUP Information and Communication Technology Office (PUP-ICTO) initiated a historical server activity audit and conducted a thorough review of the application and system logs:
...
2. PUP ICTO checked unexpected query of records through thorough review of SIS application logs and the DB system logs.
3. Changed the passwords of the admin user accounts that has registrar access to the system DB.
4. PUP ICTO discussed the current situation to PUP Executive Committee and informed the latter of the counter-measures done by the ICTO.[^5]

It discovered that nine hundred ninety-one (991) email addresses of PUP Student Information System (SIS) users matched with the three thousand eight hundred nine (3,809) emails posted on the ZeroSecurity PH's Facebook page.[^6]
...
2. There is no direct access to the online database and the hackers simply compiled it from different sources.[^7]

The Commission, through its Complaints and Investigation Division (CID), issued an Order dated 20 May 2022 directing PUP to submit its Post Breach Report within fifteen (15) days from its receipt of the Order.[^8]

On 07 June 2022, PUP submitted its Compliance dated 03 June 2022.[^9] It expounded that:

> The 991 email addresses that matched with the email addresses published by the 'hackers' are old records. The email addresses belong to students who already graduated or have dropped out from the University. Further investigation conducted by ICTO on system logs reveals that there was no direct access to the system database and that the records were compiled from different source/s and not the Student Information System as claimed by the 'hackers'. Technically, no hacking was done but mere exploitation of an old list (physical copy) of email addresses of students and some faculty members.[^10]
...
> Contrary to Respondent's claim, names and e-mail addresses are information that may be used to enable identity fraud. An e-mail address is considered personal information and an unauthorized acquisition thereof could easily trace the identity of the data subject through the conduct of 'Phishing' attacks to obtain more information about the user which would then be used to access important accounts resulting to identity theft and financial loss.[^15]

PUP claimed in its Compliance that it notified the affected data subjects by posting a prompt in the SIS before its users are able to access the SIS.[^16] As evidence, it attached a screenshot of the notification prompt:
...
>
> Thank you for taking the time to read this. We sincerely apologize for the annoyance of having to change your password, but, ultimately, we believe this simple step will result in a more secure PUP SIS experience.[^17]
...
[^1]: In re: Polytechnic University of the Philippines, 03 June 2022, in In re: Polytechnic University of the Philippines, NPC BN 18-222 (NPC 2022).
[^2]: Order (To submit Post-Breach Report), 20 May 2022, at 2, in In re: Polytechnic University of the Philippines, NPC BN 18-222 (NPC 2022).
[^3]: Letter of Polytechnic University of the Philippines, 22 November 2018, at 1, in In re: Polytechnic University of the Philippines, NPC BN 18-222 (NPC 2022).
[^4]: Id.
[^5]: Id. at 2.
[^6]: Id.
[^7]: Id.
[^8]: Order (To submit Post-Breach Report), 20 May 2022, at 1-2, in In re: Polytechnic University of the Philippines, NPC BN 18-222 (NPC 2022).
