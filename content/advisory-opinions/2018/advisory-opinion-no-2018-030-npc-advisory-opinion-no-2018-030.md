---
title: "NPC Advisory Opinion No. 2018-030 — Collection and Publication of SOGIE Data on Candidates and Elected Officials"
description: "Advisory opinion on COMELEC's collection of sexual orientation and gender identity and expression (SOGIE) data of candidates and elected officials, addressing privacy concerns and lawful processing requirements under the Magna Carta of Women."
tags:
  - issuance
...
- Tags: COMELEC; sexual orientation and gender identity; Magna Carta of Women; candidate data
...
Re: REQUEST FOR COMELEC TO COLLECT AND PUBLISH DATA ON WOMEN AND DIFFERENTLY-GENDERED CANDIDATES AND ELECTED OFFICIALS
...
However, we understand that the Omnibus Election Code[^2] does not require the candidates to declare their SOGIE in their Certificates of Candidacy (COC). Hence, your office opined that the collection and publication of gender statistics and sex-disaggregated data of candidates may find legal basis in Section 36(c) of the Magna Carta of Women,[^3] to wit:
...
The Magna Carta of Women recognizes the role and importance of women in nation building and declares that the State endeavors to develop plans, policies, programs, measures, and mechanisms to address discrimination and inequality in the economic, political, social, and cultural life of women and men.[^4]
...
- There is uncertainty as to how such data will be actually collected through the COC form, i.e., a tick box for "Others" or a blank where candidates may indicate an open-ended response. This may be construed as gender insensitive. Also, the COMELEC may have a difficult time analyzing data from open-ended responses.
- Even if COMELEC will only publish statistics and aggregated data relating to the SOGIE collected, it is still possible for copies of the COCs to be released to the public through Freedom of Information (FOI) requests and to third parties when there are disqualification cases.
