---
title: "NPC Advisory Opinion No. 2018-038 — Personal Information Controller in the Processing of Concessionary BEEP™ Cards"
description: "Advisory opinion clarifying the role of the Department of Transportation as the personal information controller and AF Payments Inc. as the personal information processor in the issuance of Concessionary BEEP™ Cards."
tags:
  - issuance
...
- Tags: Public transport; BEEP card; data processing
...
RE: PERSONAL INFORMATION CONTROLLER IN THE PROCESSING OF CONCESSIONARY BEEP™ CARDS

Dear [Redacted],

We write in response to your request for advisory opinion received by the National Privacy Commission (NPC) which sought to clarify whether the Department of Transportation (DOTr) is considered as the personal information controller (PIC) in the context of data processing for the issuance of Concessionary BEEP™ Cards.
...
On the other hand, a PIP is any natural or juridical person to whom a PIC may outsource the processing of personal data pertaining to a data subject.[^3]

### Discussion

Based on the definitions, it is apparent that it is the DOTr, with its mandate to establish and administer comprehensive and integrated programs to improve the transportation system of the country,[^4] that has control over the AFCS, and is thereby considered as the PIC.

As described in your letter addressed to [Redacted] of AFPI dated [Redacted], personal information of the applicants is gathered by the Public Transport Operators (PTOs) then submitted to AFPI for their processing.
...
[^4]: Amending Executive Order No. 125, Entitled "Reorganizing the Ministry of Transportation and Communications, Defining its Powers and Functions, and For Other Purposes", [REORGANIZATION ACT OF THE MINISTRY OF TRANSPORTATION AND COMMUNICATIONS], Executive Order No. 125-A, (1987), §5.
[^5]: Data Controllers and Data Processors: What the difference is and what the governance implications are, pages 4 and 7, available at https://ico.org.uk/media/for-organisations/documents/1546/data-controllers-and-data-processors-dp-guidance.pdf, (last accessed on 07 June 2018).
[^6]: *Id*, page 5.
