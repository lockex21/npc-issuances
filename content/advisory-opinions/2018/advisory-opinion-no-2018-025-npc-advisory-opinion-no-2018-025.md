---
title: "NPC Advisory Opinion No. 2018-025 — Request for Information From Law Enforcement Agencies"
description: "Advisory opinion on the disclosure of passenger personal information and travel records to law enforcement agencies, including exemptions for government employee data and lawful processing requirements under the Data Privacy Act."
tags:
  - issuance
...
- System generated Cebu Air, Inc. Official Receipt No. [Redacted] dated [Redacted] for Php1,734.68; and
- Printout of the online booking with Booking Reference Number [Redacted] for [Redacted] Cebu to Butuan [Redacted].

PDEA requested Cebu Pacific to verify if indeed [Redacted] booked a flight and purchased tickets, and if he actually boarded any flights on [Redacted] and the time and destination of said travel.
...
4. The name of the individual on a document prepared by the individual in the course of employment with the government.[^5]

Thus, if the personal information being requested relates to an official trip of [Redacted] for him to perform his responsibilities as [Redacted], supported by an official document from the agency authorizing his trip, his flight details and confirmation on whether he boarded the aircraft are outside the coverage of the DPA.
...
In the event, however, that the trip of [Redacted] is personal in nature, and in no way related to the discharge of his functions in PDEA, the personal information requested is not exempt from the coverage of the law, and Cebu Pacific has the responsibility, as a personal information controller, to protect it against unauthorized processing[^6] or unauthorized disclosure.[^7]
...
Nevertheless, the PDEA may opt to simply require [Redacted] to personally obtain the certification from Cebu Pacific, seeing that this will greatly strengthen his defense and support his case, otherwise, for [Redacted] to authorize PDEA to acquire the certification in his behalf.
