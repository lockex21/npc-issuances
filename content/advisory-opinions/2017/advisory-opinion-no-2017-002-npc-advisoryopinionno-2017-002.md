---
title: "NPC Advisory Opinion No. 2017-002 — Registration of Processing System Limited Only to Activities of the Human Resources Department"
description: "Clarification on registration requirements for companies whose personal data processing is limited to human resources activities."
tags:
  - issuance
...
- Tags: data registration, human resources, personal data processing
...
3. The processing includes sensitive personal information of at least one thousand (1,000) individuals.

ECOZONE must evaluate its operations vis-à-vis the foregoing factors in order to determine if it is required to register its personal data processing system with the Commission.
