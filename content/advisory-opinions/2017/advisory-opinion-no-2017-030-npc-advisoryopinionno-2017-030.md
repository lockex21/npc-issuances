---
title: "NPC Advisory Opinion No. 2017-030 — Clarifications on the Interpretation of the Data Privacy Act of 2012"
description: "Guidance on use of databases of personal data from unlawful activities, information available in the public domain, and automated processing and decision-making with notification requirements."
tags:
  - issuance
...
There is no express mention that personal data which is available publicly is outside of its scope. Thus, "it is a misconception that publicly accessible personal data can be further used or disclosed for any purpose whatsoever without regulation."[^2]
...
Thus, even if the data subject has provided his or her personal data in a publicly accessible platform, this does not mean he or she has given blanket consent for the use of his/her personal data for whatever purposes.[^3]
...
8. Decisions relating to the data subject on the basis of processed data or that would significantly affect the rights and freedoms of data subject; and
9. Names and contact details of the compliance or data protection officer.

The provision above requires all PICs who are engaged in automated processing which leads to automated decision-making that significantly affects a data subject to notify the Commission of the said automated processing operations. In a bank, a bank should notify the Commission of its processing systems that are capable of making automated decisions.
