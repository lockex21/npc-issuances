...
The DPA applies to “any natural and juridical person involved in the personal information[^2]
processing including those personal information controllers[^3] and processors[^4] who, although
...
We understand that cooperatives are also considered as submitting entities[^10] under the
...
#### Cooperatives as Personal Information Controllers or Processors are Mandated to Comply With the Directives Provided by the DPA, Its IRR and Other NPC Issuances
...
#### Reportorial Requirements to be Submitted by Cooperatives to the NPC
...
occurred”.[^14] The report may be submitted in a written or electronic format[^15] containing the
required contents of the notification stated in Sections 20(f) and 39 of the DPA and the IRR,
respectively.

NPC Circular 16-03[^16] comprehensively discusses the framework for personal data breach
...
the penal provisions[^18], if any.
...
[^10]: RA No. 9510, AN ACT ESTABLISHING THE CREDIT INFORMATION SYSTEM AND FOR OTHER PURPOSES, "Credit Information System Act" (31 October 2008), §3(q)
