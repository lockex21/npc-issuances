...
## Source
- Reference: Advisory Opinion No. 2017-063
- Official PDF: https://privacy.gov.ph/wp-content/uploads/2022/01/NPC_AdvisoryOpinionNo._2017-063.pdf
...
Re: Personal and Sensitive Information

Dear [Redacted],

This pertains to your query received by the National Privacy Commission (NPC) on 25 July 2017, via Facebook. Specifically, your query pertains to the following:

a. NPC's stand on blacklisting
b. Clarification on hand-written signatures being considered as biometrics and sensitive personal information
c. If the following information in an application system is considered as personal or sensitive personal information:
   1. Username
   2. Password
   3. IP/MAC address
   4. Current location
   5. Cookies
d. If birthday (consist of month and day only) is considered a personal or sensitive personal information.
...
Note however that the DPA defines sensitive personal information as personal information, to wit:
...
(4) Specifically established by an executive order or an act of Congress to be kept classified.[^8]

In light of the above provisions, it is imperative to note that the specific data you inquired may all fall under the ambit of personal information but are not considered as sensitive personal information.
...
[^6]: Id., §3(g).
[^7]: EU Directive 95/46/EC Working Party Document No. WP 105 noted that "Data relates to an individual if it refers to the identity, characteristics or behavior of an individual or if such information is used to determine or influence the way in which that person is treated or evaluated."
[^8]: Id., §3(l).
