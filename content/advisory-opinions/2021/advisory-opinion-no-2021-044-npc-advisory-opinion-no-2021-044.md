---
title: "NPC Advisory Opinion No. 2021-044 — Disclosure of Academic Records in Support of Administrative and Criminal Complaints"
description: "Addresses the disclosure of academic records by an educational institution in relation to the filing of administrative and criminal complaints against a faculty member, addressing special cases under the Data Privacy Act and Section 13(f) regarding establishment of legal claims."
tags:
  - "issuance"
...
2. Official Transcript of Records for Doctor of Philosophy in Educational Management issued by another specified university;
...
In determining whether a request based on the aforementioned provision should be granted, the legitimacy of the purpose and the proportionality of the request shall be taken into consideration. In this instance, we note that the request indicates a specific set of documents and declares a clearly defined purpose.
