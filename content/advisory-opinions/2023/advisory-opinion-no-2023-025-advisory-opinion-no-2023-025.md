...
In BGM v. IPP[^7], we had the occasion to clarify the nature of processing pursuant to Section 13(f), mainly:
...
Personal data must be collected for specified and legitimate purposes which must be determined and declared beforehand and processed only in a way that is compatible with such declared and specific purpose.[^8] Further, PICs must ensure that personal data is accurate and relevant at all times.[^9] Personal data processed should be proportionate, adequate and not excessive in relation to the purposes for which they were collected.[^10] To reiterate, data subjects must be aware of the nature, purpose and extent of the processing of his or her personal data, including the risks and safeguards involved and their rights as data subjects, among others.[^11]
