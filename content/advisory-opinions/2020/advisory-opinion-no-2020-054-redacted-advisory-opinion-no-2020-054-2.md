---
title: "NPC Advisory Opinion No. 2020-054 — Personal Data Collection and Retention Using QR Codes for Contact Tracing"
description: "Advisory opinion on the collection of personal data and retention period for QR code-based COVID-19 contact tracing systems under the Data Privacy Act."
tags:
  - issuance
...
- Official PDF: https://privacy.gov.ph/wp-content/uploads/2022/01/Redacted-Advisory-Opinion-No.-2020-054.pdf
- Issue date: 12/28/2020
- Tags: covid-19, contact-tracing, sensitive-data, retention, proportionality
...
Re: PERSONAL DATA COLLECTION AND RETENTION USING QR CODES FOR CONTACT TRACING
...
The Supreme Court held in *Dela Cruz vs. Paras*[^4] that "ordinances passed by virtue of the implied power found in the general welfare clause must be reasonable, consonant with the general powers and purposes of the corporation, and not inconsistent with the laws or policy of the State."
...
>
> 7. All other personal data collected for the management of probable, suspected and confirmed COVID-19 patients shall be stored only for as long as necessary or when the purpose for processing still exists.[^7]
...
a. The personal data is:
   i. incomplete, outdated, false, or unlawfully obtained;
   ii. being used for purpose not authorized by the data subject;
   iii. no longer necessary for the purposes for which they were collected; or
...
e. The personal information controller or personal information processor violated the rights of the data subject.[^8]
