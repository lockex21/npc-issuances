---
title: "NPC Advisory Opinion No. 2020-003 — Information on Vehicle Ingress and Egress"
description: "Clarifies whether vehicle ingress and egress information constitutes personal information under the DPA and determines data ownership between registered vehicle owners and actual drivers."
tags:
  - issuance
...
- Official PDF: https://privacy.gov.ph/wp-content/uploads/2022/01/Redacted-Advisory-Opinion-No.-2020-003.pdf
...
As defined under the DPA, personal information is any information from which the identity of an individual is apparent or can be reasonably and directly ascertained by the entity holding the information, or when put together with other information would directly and certainly identify an individual.[^3]
...
Given the foregoing, details on a vehicles ingress and egress are considered as personal information under our law. SCC, as the personal information controller (PIC), has the responsibility to process, which includes disclosure, said personal information in accordance with the provisions of the DPA and its [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012|implementing rules and regulations]], including the implementation of reasonable and appropriate security measures for the protection of personal information, adherence to the general data privacy principles, and upholding data subjects’ rights.
...
In the case at hand, SCC may also consider [[laws/data-privacy-act-of-2012#section-12-criteria-for-lawful-processing-of-personal-information|Section 12(f) of the DPA]] on legitimate interest which allows processing (i.e. disclosure) that is necessary for the purposes of the legitimate interests pursued by the PIC or by a third party or parties to whom the data is disclosed, except where such interests are overridden by fundamental rights and freedoms of the data subject which require protection under the Philippine Constitution.

In order to use legitimate interest as basis for lawful processing, PICs must consider the following:[^4]
...
3. Balancing test – The fundamental rights and freedoms of data subjects should not be overridden by the legitimate interests of the PICs, considering the likely impact of the processing on the data subjects.[^5]
