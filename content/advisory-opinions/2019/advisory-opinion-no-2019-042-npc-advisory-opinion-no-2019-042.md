...
1. Whether the request of the law firm will require the consent of the several affected declared owners/data subjects whose names and last known addresses are printed on the face of the tax declarations; and
...
Due consideration should also be given to the information requested and whether it is relevant and material to the declared purpose of the requesting party. In this case, the Spouses are requesting information to guide them in taking the proper cause of action. The Office of the City Assessor previously communicated to the Spouses the seeming overlap of portions of the subject property and other declared properties belonging to other owners and the possible need to settle conflicts of ownership.
