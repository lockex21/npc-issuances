---
title: "NPC Advisory Opinion No. 2019-021 — Assignment of a Non-Resident DPO and Requirements for DPO Contact Details"
description: "Guidance on the appointment of non-resident Data Protection Officers and requirements for contact details and local phone numbers."
tags:
  - issuance
...
## Source
- Reference: Advisory Opinion No. 2019-021
- Official PDF: https://privacy.gov.ph/wp-content/uploads/2022/01/v1Redacted-Advisory-Opinion-No.-2019-021.pdf
...
Considering also that the DPO is the contact person of the NPC, having a local mobile number is advisable as it will enable the NPC to communicate with the DPO directly in case there is a personal data breach which will necessitate immediate action and response.
...
In addition, while a group of related companies may appoint or designate the DPO of one of
its members to be primarily accountable for ensuring the compliance of the entire group with
all data protection policies, such appointment is still subject to the approval of the NPC and,
if so allowed, the other members of the group must still designate a Compliance Officer for
Privacy (COP).
