---
title: "NPC Advisory Opinion No. 2019-032 — Storage and Sharing of Electronic Medical Records"
description: "Advisory opinion on data protection measures for storage and sharing of electronic medical records and anonymized medical data under the Data Privacy Act."
tags:
  - issuance
...
The DPA defines a PIC as an organization which controls the collection, holding, processing or use of personal information.[^2] A personal information processor (PIP), on the other hand, is a juridical person to whom a PIC may outsource or instruct the processing of personal data pertaining to a data subject.[^3]
...
We understand that when using personal data for medical research purpose, the processing should comply with the requirements of applicable laws, regulations, or ethical standards, including but not limited to obtaining an informed consent from the patient, unless the processing may be justified by some other lawful criteria provided for under the DPA.[^6]
...
- **g.** Encryption of personal data during storage and while in transit, authentication process, and other technical security measures that control and limit access.[^7]
