...
However, we take this opportunity to emphasize that Bayad Center, as a personal information controller (PIC), is ultimately responsible for compliance to the law, including adherence to the data privacy principles of transparency, legitimate purpose, and proportionality.[^3] Under the DPA, each PIC is responsible for personal information under its control or custody, including information that have been transferred to a third party for processing.[^4]
