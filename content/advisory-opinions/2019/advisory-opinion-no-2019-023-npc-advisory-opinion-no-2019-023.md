---
title: "NPC Advisory Opinion No. 2019-023 — Processing of CCTV Footage Under the Data Privacy Act"
description: "Advisory opinion on whether CCTV is allowed under the DPA and whether CCTV footage is admissible as evidence in court, addressing lawful processing, workplace monitoring, and employee privacy rights."
tags:
  - issuance
...
- The processing is necessary for compliance with a legal obligation to which the personal information controller (PIC) is subject;
...
3. Balancing test - The fundamental rights and freedoms of data subjects should not be overridden by the legitimate interests of the PIC, considering the likely impact of the processing on the data subjects.[^6]
...
Likewise, we wish to emphasize that although employees are within office premises and using company-issued equipment within office hours, they still are entitled to their right to privacy at work.[^8] With the emergence of new technologies that provide employers with vast opportunities to monitor and track employees, unbridled checking can damage trust, disrupt professional relationships and disturb workplace peace and performance.[^9]
