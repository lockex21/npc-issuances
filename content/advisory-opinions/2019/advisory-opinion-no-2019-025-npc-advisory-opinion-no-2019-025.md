---
title: "NPC Advisory Opinion No. 2019-025 — Disclosure of the Names of Unit Owners/Members of a Condominium Association"
description: "Advisory opinion on whether a condominium association may disclose member names for quorum purposes under the DPA, addressing legal obligations under the Revised Corporation Code and data retention requirements."
tags:
  - issuance
...
The names of the members of the Association and their respective membership standing are considered as personal information. Personal information under [[laws/data-privacy-act-of-2012#section-3-definition-of-terms|Section 3(g) of the DPA]] is defined as any information whether recorded in a material form or not, from which the identity of an individual is apparent or can be reasonably and directly ascertained by the entity holding the information, or when put together with other information would directly and certainly identify an individual.

[[laws/data-privacy-act-of-2012#section-12-criteria-for-lawful-processing-of-personal-information|Section 12 of the DPA]] provides the for the various criteria for lawful processing of personal information. Specifically, Section 12(c) appears to be relevant to the issue at hand, which states as follows:
...
In relation to the above provision, Section 73 of the Revised Corporation Code[^3] provides:
...
In your case, the Association has a legal obligation to its members, rooted in Section 73 of the Revised Corporation Code, to provide access to and inspect corporate records and documents.[^4] The DPA does not operate to curtail existing rights of members of a condominium corporation, specifically on inspection of corporate books and records, subject to existing laws and regulations on such matters.[^5]
...
It is also worthy to note that under [[laws/data-privacy-act-of-2012#section-11-general-data-privacy-principles|Section 11(e) of the DPA]], personal information must be retained only for as long as necessary for the fulfillment of the purposes for which the data was obtained.
...
[^3]: An Act Providing for the Revised Corporation Code of the Philippines [Revised Corporation Code of the Philippines], Republic Act No. 11232 (2019).
