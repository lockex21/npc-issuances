...
## Source
- Reference: Advisory Opinion No. 2025-008
- Official PDF: https://privacy.gov.ph/wp-content/uploads/2025/09/NPC-Advisory-Opinion-No.-2025-008.pdf
...
insured the lives of its debtor-pensioners. On behalf of PVB, IPI, a wholly owned subsidiary
of PVB, facilitates the processing of the insurance claims upon the death of debtor-pensioners.

For the processing of benefits upon the death of the pensioners, the heirs submit copies of the
pensioners’ death certificates to PVAO. Thus, PVAO retains copies of the pensioners’ death
certificates primarily to facilitate the administration and release of pension benefits.

Further, you also mentioned that IPI has an existing Data Sharing Agreement (DSA) with the
Philippine Statistics Authority (PSA) for the purpose of securing copies of the death
...
In line with this, you now seek guidance on whether there is a need to execute a DSA with IPI
in releasing copies of the pensioners’ death certificates relative to PVB’s insurance claims. You
also seek guidance on whether releasing the pensioners’ death certificates to IPI, without
informing the pensioners’ relatives or seeking their consent would be violative of the DPA, its
IRR or any related NPC issuances.
...
From the facts previously disclosed by IPI, it appears that its request may be justified under
Section 12(b) on fulfillment of a contract with the data subject and Section 13(f) on
establishment or exercise of legal claims. The requested death certificates are necessary to
fulfill the contract entered into with the data subject and for PVB to establish its legal claims
for the processing of the insurance proceeds to settle the unpaid loans availed by the deceased
debtor-pensioners.

It is important to note, however, that it is not enough to merely invoke a lawful basis or
legitimate purpose. The requesting party must be able to substantiate its legitimate purpose
with supporting documents. Thus, such requests should be evaluated on a case-to-case basis
and must always be subject to the personal information controller’s (PIC) guidelines for the
release of such document or information.

Further, the death certificates submitted by the heirs to PVAO for the processing of the
pensioners’ benefits are already considered to be in PVAO’s official possession. Thus, the
PVAO, as a PIC, may process the same for whatever purpose/s it may serve without having
to seek the consent of the pensioners’ heirs, taking into account the provisions of the DPA and
other relevant laws.

As such, the requested documents may be lawfully released to IPI, subject to PVAO’s internal
...
one as the same demonstrates accountability. A DSA between PVAO and IPI is encouraged,
especially so that PVAO is merely a recipient of the requested death certificates. The same
likewise demonstrates good faith in complying with the provisions of the DPA, its IRR, and
relevant issuances of the NPC.

General data privacy principles;
Security measures

As mentioned, although there is lawful basis for the processing of personal data, the other
requirements of the DPA must still be complied with to ensure the protection of personal data
...
Additionally, in NPC Advisory Opinion No. 2021-044, it was recommended that:
   ...
   “xxx in case a request for personal information is granted, the
              ...
              undertaking must include a clause to the effect that the requestor
              acknowledges that he/she becomes a PIC by his/her receipt of the
              requested documents and therefore has the obligations of a PIC as
              prescribed under the DPA.”

Moreover, the principle of proportionality provides that the processing of information shall
...
not reasonably be fulfilled by other means. It necessitates that only the information requested
and necessary for the purpose indicated should be processed. As such, in line with the
proportionality principle, we reiterate the discussion in the above cited Advisory Opinion that
a certification of death may suffice as an alternative considering that the insurance policy
...
Most importantly, it is mandatory for all PICs to implement reasonable and appropriate
organizational, physical, and technical security measures for the protection of personal data.
As highlighted in existing jurisprudence, processing personal data even involving the
government does not, by itself, ensure its security absent any express guarantee that adequate
safeguards are in place for protection.
