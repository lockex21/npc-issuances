...
## Source
- Reference: Advisory Opinion No. 2025-004[^1]
...
Re: DATA SHARING PROTOCOLS BETWEEN GOVERNMENT AGENCIES TO STREAMLINE IDENTITY VERIFICATION
...
You inform that when the PNP was established in 1990, members of the Philippine Constabulary (PC) were given the option to join either the PNP or the Armed Forces of the Philippines (AFP). Under Republic Act No. 6948,[^3] or the law governing the pensions benefits of military personnel, the term “beneficiaries” does not only include AFP veterans who served for at least six (6) years but also former PC members who opted to join the PNP. Hence, the common pensioners of PVAO and the PNP.

Currently, PVAO is implementing a Single ID System Program (the “Program”), which streamlines the identification and updating of the records of pensioners and reduces the cost and simplifies transactions for veterans and their eligible dependents. At present, Single IDs are only issued to retired AFP personnel and PVAO pensioners aged sixty-five (65) and above. But PVAO intends to extend the Program to future PVAO pensioners who are PNP retirees below sixty-five (65) years old to allow them to access non-pension benefits, such as medical care and hospitalization assistance. However, PVAO faces challenges in validating the identity and documentary requirements of these future PVAO pensioners from the PNP as there are no mechanisms in the processing of data between PVAO and the PNP; hence, your present request.
...
e) Implementation of reasonable and appropriate organizational, physical, and technical security measures intended for the protection of personal data against any accidental or unlawful destruction, alteration, and disclosure as well as against any other unlawful processing.[^7]

In this regard, worthy of note is the concurring opinion of Justice Caguioa in the case of *Integrated Bar of the Philippines vs. Purisima*,[^8] where the Supreme Court struck down for being violative of privacy rights a Revenue Regulation requiring the registration of appointment books of professionals containing their clients’ names and the date and time of consultation. Justice Caguioa wrote:

> xxx I would like to add that this requirement violates the general principle of proportionality that is espoused in Republic Act No. 10173 or the Data Privacy Act of 2012, viz:
>
> Sec. 18. Principles of Transparency, Legitimate Purpose and Proportionality. – The processing of personal data shall be allowed subject to adherence to the principles of transparency, legitimate purpose, and proportionality.
> xxx
>
...
>
> xxx requiring self-employed professionals to disclose their clients’ names and their appointment schedules is already excessive vis-à-vis the declared purpose of RR 4-2014 xxx

Justice Lazaro-Javier likewise gave the concurring opinion in the same case that the assailed provision is void as it violates the requirement for data sharing between government agencies under NPC Circular on Data Sharing Agreements in that there are mechanisms by which to conduct such data sharing.

As such, it is crucial for PICs, such as PVAO and PNP, to ensure that only personal data necessary, adequate, relevant, and not excessive in relation to the specified and declared purpose are processed.

In addition to the foregoing, government agencies, as PICs, are likewise required to ensure that there are mechanisms in place for the protection of personal data as well as the rights of the data subjects.

In the case of *Ople vs. Torres*,[^9] the Supreme Court emphasized:

> We can even grant, arguendo, that the computer data file will be limited to the name, address and other basic personal information about the individual. Even that hospitable assumption will not save A.O. No. 308 from constitutional infirmity for again said order does not tell us in clear and categorical terms how these information gathered shall be handled. It does not provide who shall control and access the data, under what circumstances and for what purpose. These factors are essential to safeguard the privacy and guaranty the integrity of the information. Well to note, the computer linkage gives other government agencies access to the information. Yet, there are no controls to guard against leakage of information. xxx
>
