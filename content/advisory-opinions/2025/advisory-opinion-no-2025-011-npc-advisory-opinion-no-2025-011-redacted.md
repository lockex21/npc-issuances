---
title: "NPC Advisory Opinion No. 2025-011 — Request for Documents Containing Personal Data by a Government Agency"
description: "Addresses compliance with Bureau of Internal Revenue requests for documents containing personal data in relation to data protection obligations."
tags:
  - "issuance"
...
The BIR thereafter transmitted a First Notice dated 18 June 2025, containing a request for Globe to submit the following additional documents, among others: (1) Billing Summary File; (2) Subscriber Masterfile; (3) Billing Transaction File; and (4) Call detail record. This has raised concerns on your end as these contain the personal data of [Redacted] subscribers, such as their name, address, birthdate, mobile numbers, and call logs.

On 03 July 2025, [Redacted] wrote to BIR a request-reply to clarify or discuss the purpose of their requested documents. However, BIR issued a Second and Final Notice dated 17 July 2025, citing Section 20 of Revenue Regulation No. V-1, which stated that:
...
> [I]nformation required by a public authority in the exercise of its regulatory function pursuant to its constitutional or statutory mandate falls outside the DPA's scope. However, as we have previously stated in Advisory Opinion No. 2020-015, this exemption must be interpreted strictly such that:
>
...
As the primary agency tasked with the enforcement of national internal revenue laws, the BIR, through its Commissioner, is vested with the power to obtain information necessary to ensure taxpayer compliance and proper tax administration. The determination of what information is necessary for such purpose falls within the sound discretion of the BIR.

Specifically, Section 5(B) of the National Internal Revenue Code (NIRC) provides:
...
While the disclosure of information relating to individual taxpayers may be lawfully undertaken by the BIR, such actions are presumed to be carried out in the regular performance of its official duties. This includes the issuance of an LOA and the corresponding request for documents and information relevant to a tax investigation or audit.

We recognize [Redacted] concern regarding the disclosure of documents containing the personal data of its subscribers. However, it is important to emphasize that the BIR is acting within its statutory mandate. The issuance of its LOA and the subsequent requests for specific documents fall within its power. Notably, in NPC Advisory Opinion No. 2024-016, the BIR merely made a verbal request, as compared to the present request, which was made through an LOA.

Nonetheless, both [Redacted] and the BIR, as Personal Information Controllers (PICs), are expected to maintain appropriate safeguards in handling such data. Where it involves the personal data of subscribers, both must ensure that data sharing is clearly documented to ensure accountability. PICs, as vested by law with the safekeeping of personal information, must guard it not only based on obligation, but as a solemn trust – never swayed by whim, but based on duty and care.
