...
Processing, under Section 3(j) of the DPA[^4] and Rule II, Section 3(k) of the IRR, includes any operation performed on personal data such as use, storage, retrieval, consultation, transfer, or destruction.[^5] Unauthorized processing occurs when personal data is handled without proper authority, even if done by someone who otherwise has access within their official capacity.[^6]

Section 20 of the DPA requires personal information controllers (PICs) to implement reasonable and appropriate organizational, physical, and technical security measures to protect personal data against unauthorized access or processing. They must ensure that anyone acting under their authority processes personal data only on their instructions or as required by law.[^7] Rule VI, Section 26 of the Implementing Rules and Regulations further elaborates on these security requirements.[^8]
