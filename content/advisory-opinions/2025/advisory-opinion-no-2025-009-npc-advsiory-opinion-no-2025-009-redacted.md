---
title: "NPC Advisory Opinion No. 2025-009 — Unauthorized Handling of Student Transcript of Records"
description: "On whether unauthorized removal and handling of student transcripts of records outside established protocols violates data privacy and security requirements under the Data Privacy Act."
tags:
  - "issuance"
...
## Source
- Reference: Advisory Opinion No. 2025-009
- Official PDF: https://privacy.gov.ph/wp-content/uploads/2025/09/NPC-Advsiory-Opinion-No.-2025-009_Redacted.pdf
...
Re: UNAUTHORIZED HANDLING OF STUDENT TRANSCRIPT OF RECORDS (TORS)
...
1. Whether the unauthorized removal and handling of TORs for signature by another employee to be signed in any other place than the OUR violates the Data Privacy Act of 2012.
2. Whether the acts of the concerned personnel amount to unauthorized processing, improper disposal, or unlawful disclosure of sensitive personal information under the DPA.
3. Whether the liability may extend to both the Registrar II and Registrar IV, considering their roles in handling sensitive data.

### Discussion

#### Sensitive Personal Information; Processing; Security Measures

[[laws/data-privacy-act-of-2012#section-3-definition-of-terms|Section 3(g) of the DPA]] defines personal information as “any information whether recorded in a material form or not, from which the identity of an individual is apparent or can be reasonably and directly ascertained by the entity holding the information, or when put together with other information would directly and certainly identify an individual.”[^2] Section 3(l) then defines sensitive personal information to include, among others, information “specifically established by an executive order or an act of Congress to be kept classified, as well as those issued by government agencies peculiar to an individual such as… educational, financial, or employment records.”[^3] Student TORs contain academic records, grades, and other educational information that directly identify students, thus making TORs sensitive personal information.

Processing, under Section 3(j) of the DPA[^4] and Rule II, [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012#section-3-definitions|Section 3(k) of the IRR]], includes any operation performed on personal data such as use, storage, retrieval, consultation, transfer, or destruction.[^5] Unauthorized processing occurs when personal data is handled without proper authority, even if done by someone who otherwise has access within their official capacity.[^6]

[[laws/data-privacy-act-of-2012#section-20-security-of-personal-information|Section 20 of the DPA]] requires personal information controllers (PICs) to implement reasonable and appropriate organizational, physical, and technical security measures to protect personal data against unauthorized access or processing. They must ensure that anyone acting under their authority processes personal data only on their instructions or as required by law.[^7] Rule VI, [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012#section-26-organizational-security-measures|Section 26 of the Implementing Rules and Regulations]] further elaborates on these security requirements.[^8]
...
[[laws/data-privacy-act-of-2012#section-26-accessing-personal-information-and-sensitive-personal-information-due-to-negligence|Section 26 of the DPA]] penalizes providing access to personal or sensitive personal information to individuals not authorized by law, or its release to a person without authority, whether intentional or through negligence.[^9] Here, there is no showing that the TOR contents were actually disclosed to unauthorized persons, nor that the personnel acted wholly outside their authority as employees tasked with processing student records. However, the removal of the TORs from the OUR and their handling outside the established chain of custody indicate a deviation from organizational security measures required under Section 20 of the DPA. Such lapses, while not conclusive of a punishable act under Section 26, may still amount to a major infraction under [[issuances/2022/guidelines-on-administrative-fines|NPC Circular No. 2022-01]] (Guidelines on Administrative Fines),[^10] which allows for the imposition of penalties for violations committed in the course of processing, subject to proper fact-finding.

#### Extent of potential liability of the involved personnel; University policy and internal administrative and disciplinary mechanisms
...
[^3]: Id. § 3, ¶ l(2).
[^4]: Id. § 3, ¶ j.
[^5]: Rules and Regulations Implementing the Data Privacy Act of 2012, § 3(k).
[^6]: Data Privacy Act of 2012, § 25.
