---
title: "NPC Advisory Opinion No. 2025-002 — Request for Certificates of Title and Tax Declarations Without Property Owner Consent"
description: "On whether a bank may lawfully obtain certificates of title and tax declarations from government agencies without property owner consent for asset search purposes."
tags:
  - "issuance"
...
However, you mention that the Bank has encountered significant challenges in obtaining property data from relevant government agencies, which have frequently denied requests for disclosure of property records due to the absence of a written authority or waiver from the registered owner.
...
Section 3(a) of NPC Circular No. 2023-07[^4] defines legitimate interest as any actual and real benefit or gain derived from processing personal information. This definition supports the view that a PIC, such as the Bank, may process personal data to assess or protect its financial exposure, provided that the data subject’s rights are not unduly infringed.
