...
description: "Breach notification resolution finding that Infosys BPM-Philippines committed a personal data breach by unintentionally disclosing an employee's marital status via email, but that its remedial measures were sufficient to warrant case closure with a stern warning."
tags:
  - resolution
  - type/resolution
  - year/2018
...
This Resolution refers to the Breach Notification Report[^1] dated 24 October 2018 submitted by Infosys BPM-Philippines (Infosys) to this Commission.

### Facts

On 24 October 2018, a Human Resource (HR) personnel from Compensation and Benefits unintentionally disclosed the Marital Status of a fellow employee to unauthorized individuals via e-mail.[^2]

On 26 October 2018, or two (2) days after the incident, the affected employee filed a complaint with the HR and Legal Department about the incident. The Corporate Counsel then forwarded the complaint to the Data Protection Officer (DPO) for further investigation.[^3] On the same day, the DPO called each of the nine (9) unauthorized recipients of the e-mail, and notified them to sensitize, not to forward, and ensure the deletion of the e-mail.[^4] Furthermore, an incident report was also logged in the incident management tool of the company to formalize the complaint and started the investigation.[^5]

On 30 October 2018, as part of the investigation, the DPO had a meeting with the affected employee and assured her that her concern is being handled accordingly.[^6]

Infosys also reported that the effects or consequences of the incident are: (1) privacy breach of confidential information, and (2) employee dissatisfaction.[^7]
...
> 3. A confidentiality breach resulting from the **unauthorized disclosure of or access to personal data.**[^8]
...
>
> The Commission reserves the right to require additional information, if necessary.[^10]
...
Furthermore, the administrative hearing that was conducted, the disciplinary sanction that was imposed upon the erring employee, and the conduct of Data Privacy awareness activity across the organization were important steps to prevent the recurrence of the incident.
...
[^1]: Annual Security Incident Report (Data Breach Information) dated 24 October 2018 submitted by Infosys BPM-Philippines.
[^2]: *Ibid.*
[^3]: *Ibid.*
[^4]: *Ibid.*
[^5]: *Ibid.*
