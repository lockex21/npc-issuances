...
description: "Lazada are the proper PIC s that should h ave reported this breach to the CID BN no. 18 -086"
tags:
  - "resolution"
  - "type/resolution"
  - "year/2018"
...
## Source Tags
- Notification to the Commission and affected data subjects
...
its e mployee’s personal bank account.

The Facts

On 04 June 2018, a n e mployee of TSPI went to the Banco De Oro

(“BDO ”) ATM in Paniqui , Tarlac to withdraw from her personal account.

Upon checking the balance, she fou nd out that the amount of P10,000.00
...
03 June 2018 , and both co nsummated at Makati City. Said payments were
...
Division ( “CID ”), the DPO of TSPI confirmed that the account involve d
...
of this Commission. CID BN no. 18 -086
...
(that such una uthorized acquisitions is likely to give rise to real
...
information controller even if the processing of informa tion is
...
its compliance with the notification requirement s provided in this

Circular…” (Emphasis supplied)

It can be inferred from the above that the PIC has the responsibility of

notify ing both the Commission and the affected data subjects when
...
Lazada are the proper PIC s that should h ave reported this breach to the CID BN no. 18 -086

> In re: Tulay sa Pag -unlad, Inc
> Page 3of 4

Commission. BDO as the bank who holds the per sonal account of the TSPI

employee and Lazada as the merchant who processed the payment s made
...
una uthorized person. Clearly, this case falls under the required notification
...
Deputy Privacy Commissioner CID BN no. 18 -086
