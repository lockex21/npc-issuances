...
description: "Breach notification resolution denying E-Science Corporation's request for exemption from notifying affected data subjects, holding that names, email addresses, and testing logs constitute information that may enable identity fraud."
aliases:
  - "NPC BN 20-124"
  - "npc bn 20-124"
...
For the Commission’s resolution is the Request for Exemption to Notify the Data Subjects from E-Science Corporation (“E-Science”) dated 28 August 2020 involving a data breach incident affecting approximately four thousand (4,000) test records of data subjects.[^1]

### Facts

On 6 August 2020, this Commission issued a Resolution[^2] with the following disposition, to wit:
...
>
> C. The personal information controller or the Commission believes that the unauthorized acquisition is likely to give rise to a real risk of serious harm to any affected data subject.[^6]

In its Request for Exemption to Notify the Data Subjects,[^7] E-Science has stated that after its full investigation, it has confirmed that only names, e-mail addresses and testing logs were involved in the subject breach incident.
...
> **Computer-related Identity Theft.** – The intentional acquisition, use, misuse, transfer, possession, alteration or deletion of identifying information belonging to another, whether natural or juridical, without right: Provided, That if no damage has yet been caused, the penalty imposable shall be one (1) degree lower.[^9]

In the case of *Disini, et al. v. Secretary of Justice, et. al.*,[^10] the Supreme Court recognized that the use of identifying information regarding a person could perpetrate the commission of identity theft. The Court had this to say on the crime of Identity Theft:
...
Theft of identity information must be intended for an illegitimate purpose.[^11]
...
[^1]: Exemption Request to Notify the Data Subjects for NPC BN 20-124 submitted by E-Science Corporation dated 18 August 2020.
...
[^8]: What is Phishing? Accessed from https://www.phishing.org/what-is-phishing, last September 11, 2020.

[^9]: Emphasis supplied.

[^10]: GR No. 203335, February 11, 2014.
...
[^15]: See, Initial Breach Report dated 2 July 2020 and Full Breach Report dated 18 August 2020.
