...
description: "Motion for Reconsideration on the December 17, 2020 Decision finding PLDT Enterprise liable for unauthorized processing and disclosure of RLA's personal information and ordering nominal damages of P50,000.00."
aliases:
  - "NPC 18-010"
  - "npc 18-010"
...
- Official PDF: http://privacy.gov.ph/wp-content/uploads/2023/05/02-NPC_18_010_RLA_v_PLDT_Enterprise_Resolution_w_Dissenting_Opinion.pdf
- Source page: http://privacy.gov.ph/resolutions/
- Issue date: December 17, 2020
- Published on NPC site: Fri, 19 May 2023 17:31:24 GMT
- Pages: 58
## Source Tags
...
names, addresses, and tele phone numbers of its subscribers, the
...
processing under Section 12 (c) of the DPA 10 :
...
since it did not act with gross negligence 13 :
...
Resp ondent's "responsible persons, officers, or individuals"
...
implemented at the time t hat the Corporate Individual DSL of
...
2018.[^17]
PLDT argues that it only act ed as a Personal I nformation Processor
...
connected to the corporate clie ntele (e.g., primarily the
...
clients/customers th at provide to herein Respondent the
...
services. Since the applicati on involved referred to a Corporate
...
information that Knu tsen collected to allow it to provide DSL services
to specific Knu tsen employees :
As the corporate client, Knu tsen collected the relevant personal
data of the Complainant and provided such information to
Respondent to enable the latter to provide the subscribed
service s. As noted by the Honorable Commission in its Decision,
Complainant’s personal information was supp lied by his
employer, Knu tsen, the subscription was named under Knu tsen
(but for the account of Complainant), Knu tsen ’s President and
General Manager is the signatory in the Application form, and
Knu tsen ’s address is indicated in the billing portion of the
application for m. Respondent only collected the information
necessary to provide the service obtained by Knu tsen for its
...
Knu tsen and Respondent. Stated differently, Respondent is
tasked with processing of the personal information of Knu tsen ’s
employees for the purpose of providing the DSL services which
Knu tsen ’s employees will use to perform their duties and
...
Commis sion shall proceed to further clarify its reasons for denying
...
disclose personal inform ation on his or her behalf.” 26
...
Knu tsen.28 It maintains that its Enterprise Group entered into a
cont ract with  Knu tsen  to provide the Corporate Individual DSL
...
Knu tsen, as RLA ’s employer, outsourced 30 or directed the transfer of
...
Knu tsen  who “directs [it] as to t he services rendered and for who[m]
...
the pieces of information that  Knu tsen  collects from its employees,
which  Knu tsen, in turn, supplies to PLDT 33 :
...
subscription” 37 and that it was  Knu tsen  who provided the required
information to PLDT.38 Alth ough it was  Knu tsen  who submitted
RLA ’s personal information to PLDT to facilitate the installation of the
Corporate Individual DSL account,  Knu tsen  and RLA would not have
known what categories of personal information they needed to submit
without PLDT ’s instruction s. Aside from this, it was PLDT that
...
absolv e those that provid e services of any responsibility whenever an
employer submits the personal information of or pays for services for
its employees.
Following PLDT ’s logic, for instance, a compan y such as a health
insurance provider, who processes a lot of sensitive personal
information, will not be considered a PIC simply because it wa s the
employer who chose which of its employees should be covered,
provide d their personal information to the insurance company, and
pa id the insurance premium. This is clearly not what the DPA
contemplates.
...
citi zenship within the Internet community, PLDT will
respond appropriately in the event that it becomes aware of
any inappropriate use of the service. PLDT reserves the right
to monitor bandwi dth, usage and content, and from time to
time to operate the service t o identify violators of the
...
sole discretion, would be considered inappropr iate, PLDT
...
all or any port ion of the PLDT Data Service, without incurring
...
shows that PLDT undertakes certai n processing activities such as
...
in consistent w ith the relationship between a supposed PIP and its
PICs.
...
any input from  Knu tsen  or any of its Enterprise clien ts who are
...
of what PIPs can do on their own. Sec tion 44(b)(1) of the IRR provides
...
only the types of personal information it requi red  Knu tsen  and RLA to
...
Section 149. Telephone Directory. – Each telephone public
service shall at least once a year issue a listing dire ctory
showing therein the names of all subscribers arranged in
alphabetical order, their addresses and telephone numbers
and such other information as may be of interest to a
subscriber’s everyday use of his telephone. Each subscriber
...
Section 2.2 - Any data supplied by the consumer shall be
treated as confidential by the entity or ser vice provider
mentioned under Section 1.1 hereof and shall not be used for
purposes not authorized by him. Upon subscription, he shall
be informed of his right to privacy and the manner by which
his data would be protected. In cases where a public
director y listing of subscribers is regularly published by the
service provider, the consumer shall be given the option not
...
shall be evidenced by writt en, electronic or recorded means.
...
1. It shall treat the data as confid ential and shall not use such data
...
Aside from the o bvious fact that subscribers should be given the free
...
DPA.
At the time of RLA ’s subscriptio n in 2015, the Application Form that
...
issued by other appropriate gover nment entities.[^62]
...
Form, and its internal rules relating to the publicatio n of directories,
...
it was provid ed, would have allowed the data subject to understand
...
to not be listed in succeeding publicati ons such as the 2017 White
...
between the Complainant and PLDT, the s ame does not
...
PLDT only complied with its obligation s when it revised its
...
faith and in compliance wit h the prevailing regulations and practice at
...
proporti onality – the hallmarks of the DPA and its IRR.
...
September 2018, and re defined its policies and processes based on the
...
processing of pers onal information for unauthorized
...
but not more than One million pesos (Php1,0 00,000.00) shall
...
the data subject and could not have been reasonably forese en by
...
The third requisite of Section 28 of the DPA o r “the person processing
...
obtained by Knutsen for its emp loyees … Respondent is
...
The information collected from the Complainant are standard
information necessary for the purpose of providing the services
under the DSL sub scription (i.e. name, address, telephone
...
of the DSL services o ffered by PLDT 82
RLA only expected PLDT to process his personal information for the
purpose of providing the subscribed services s ince t he authority that
...
could not have been reasonabl y foreseen by the data subject.
The fourth requisite of Sect ion 28 is satisfied in this case. PLDT further
...
and fair processing. 85 As such, compl iance with a legal obligation as a
...
to the PIC ; (2) if the processing that the PIC performs is necessa ry to
...
Commission is not enforcing the law or regulat ion that the PIC claims
...
clearly within the manda te of the Commission.
...
contact information before a service provider can inclu de the
...
or necessary to achieve its c learly defined and stated purposes 92, which
in this case is to comply with the provisions of law and regulation.
Aside from this, t he processing undertaken by the PIC should relate to
...
included in the listing directory. It is also not di sputed that PLDT is
...
directory.
The obligation to substantia te the fulfilment of the conditions that
...
that PLDT can publish the subscriber’s persona l information in the
listing directory.
...
in the lis ting directory was proper. It is incumbent upon PLDT to show
...
adequ ately declare and specify the purpose of publishing data
...
listing ”94 especially considering that PLDT never info rmed its
su bscribers of this option in the first place.
...
personal informatio n would be protected, and inform them of their
...
2015 95, and Knutsen requested the transfer of RLA ’s Corporate
Individual DSL account to a new address on 12 April 2016. 96 PLDT
could have informed RLA in 2015, when Knut sen opened a Corporate
...
however, failed to do so. Even when the IRR of the DPA was issued o n
...
any personal information or personal sensitive info rmation
...
malice or in bad faith. 101  A finding of Malicious Disclosure requires th at
...
must be read in relatio n to the whole law. It is the cardinal
...
considered in fixing the meaning of any of its p arts in order
...
result in absurdity. Such literal interpreta tion based on an isolated
...
inconsistent provisions sho uld be reconciled whenever
...
processing, consent or otherwise, supports the disclosure of persona l
information. This interpretation is more beneficial to the accused since
it actually narrows the extent to which disclosu re of personal
...
publish personal information in the listing directo ry. It is only when
...
Here, PLDT published the personal information of its sub scribers in
...
list ed in the listing directory. PLDT failed to obtain the consent of its
...
not “rise to the level o f gross negligence that would merit criminal
...
It is established that bare allegations without evidence i s neither
...
directory listing in compli ance with the requirement
...
that the subscriber may request for his or her exclu sion in the
...
By failing to present the option to not b e listed in the directory listing
...
The Commission cannot overlook PLDT ’s inaction since 2007 in fa il ing
to acquire the consent of its subscribers since the DPA mandates that
doubt s in the interpretation should be in favor of the rights and
...
subjects.
In arguing in favor of PLDT, the dissent harps on the supposed fac t,
...
interpreted and applied.” 119 The Decision dated 17 Decem ber 2020 was
...
overlooked certain things, he o nly has himself to blame.
...
abstract notion of organizational a ccountability.[^121]
...
ar bitrarily introduce a subjective interpretation restricting the
...
It should go without saying that a ny change in the Commission’s
...
should be maintained. PLDT is liable for violation s of the DPA,
...
likewise failed to comply with its obligation under the DPA to ensur e
...
[^1]: Decision, 17 December 2020, at 26, in RLA v. PLDT Enterprise, NPC 18010 (NPC 20 20 )(pending).
[^2]: Motion for Reconsideration, 05 August 2021, at 1, in RLA v. PLDT Enterprise, NPC 18010 (NPC 20 21 )(pending).
[^3]: Id. at 12.
[^4]: Id. at 5.
[^5]: Id. at 9.
...
[^9]: Motion for Reconsideration, 05 August 2021, at 3, in RLA v. PLDT Enterprise, NPC 18010 (NPC 20 21 )(pending).
[^10]: Id. at 3.
[^11]: Id.at 5.Emphasis supplied.
[^12]: Id.
[^13]: Id. at 6.
[^14]: Id. Emphasis supplied.
[^15]: Motion for Reconsideration, 05 August 2021, at 6, in RLA v. PLDT Enterprise,NPC 18010 (NPC 2021) (pending).
[^16]: Id. at 7. Emphasis supplied.
[^17]: Id.
[^18]: Id. at 9. Emphasis supplied.
[^19]: Id.
[^20]: Id. at 11.
[^21]: Motion for Reconsideration, 05 August 2021, at 11, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021) (pending).
[^22]: Id.
[^23]: Id. at 12.
...
[^62]: Motion for Reconsideration, 05 August 202 1, at 11, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021) (pending).
[^63]: Comment to the Complaint dated 31 March 2018, 05 October 2018, at 46, in RLA v. PLDT Enterprise, NPC 18010 (NPC
[^64]: Liboro Dissenting Opinion, 10 December 2021, at 12,in RLA v. PLDT Enterprise, NPC 18010 (NPC 20 21 )(pending).
[^65]: Decision, 17 December 2020, at 11, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021) (pending). Emphasis supplied.
[^66]: Id. at 1 1-12. Emphasis supplied.
[^67]: Id. at 14. Emphasis supplied.
[^68]: Comment to the Complaint dated 31 March 2018, 05 October 2018, at Annex B, in RLA v. PLDT Enterprise, NPC 18010
[^69]: Liboro Dissenting Opinion, 10 December 2021, at 16,in RLA v. PLDT Enterprise, NPC 18010 (NPC 20 21 )(pending).
[^70]: Motion for Reconsideration by PLDT, Inc., 05 August 2021, at 8, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021)
[^71]: Liboro Dissenting Opinion, 10 December 2021, at 14, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021) (pending).
[^72]: See National Privacy Commission, Advisory on Telephone Directories, Advisory Opinion No. 21, Series of 2018 (27
[^73]: See Liboro Dissenting Opinion, 10 December 2021, at 6, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021) (pending).
...
[^107]: Comment to the Complaint dated 31 March 2018, 05 October 2018, at Annex B, in RLA v. PLDT Enterprise, NPC 18010
[^108]: Casco v. N LRC, G.R. No. 200571 (2018).
[^109]: Motion for Reconsideration, 05 August 2021, at 6, in RLA v. PLDT Enterprise, NPC 18010 (NPC 2021) (pending).
[^110]: United Claimants Association of NEA v. National Electrification Administration, G.R. No. 187107 (2012); Cordova v.
[^111]: Decision, 17 December 2020, at 22,in RLA v. PLDT Enterprise,NPC 18010 (NPC 20 20 )(pending).
[^112]: Id. at 23.
...
**WHEREFORE**, all these premises considered, this Commission
resolve s to AWARD Complainant, RLA, nominal damages in the
...
for furthe r investigation and for the determination of the responsible
...
Commission adjudicates has its peculiar f acts which may have a
...
is applied or change how data privacy is practiced in the count ry.
...
deliberation.
However, I dissent to deny the Motion for Reconside ration filed by
...
information, i.e. name, telephone numb er and residence address.
...
permitted only if not other wise prohibited by law, and when at
...
(c) The processing is necessary for compli ance with a legal
obligation to which the personal information controller is
subject;
(d) The processing is necessary to protect vitally important
interests of the data subject, including life and health;
(e) The processing is necessary in order to respond to nati onal
...
(f) The processing is necessary for the pu rposes of the
...
present. Without any of these criteria, the PIC or PIP can be held liabl e
...
the Revised Order No. 1, the Public Service Comm ission (PSC) Rules
...
public service to issue a listing directory at least once a year, to wi t:
Section 149. Telephone Directory. – Each telephone public
service shall at least once a year issue a listing directory
showing therein the names of all subscribers arranged in
...
to a fre e copy of the directory.[^128]
...
relati ve that they need to reach.
...
innovations. This created new pro ducts and services and started to
...
the Philippines was the textin g capital of the world, and to date, it
...
Section 1.1 hereof and shall not be used for purposes n ot
...
By way of example, common VAS encountered by subscri bers
included Content and Program service 135 which includes music,
...
statute's clauses and phrases must not, consequently, be take n as
...
the fundamentals of statutory construction, all the words in t he
...
telec ommunication companies as provided by Section 149 of Revised
Order No. 1.
...
numbers of its subscribers pursuant to Secti on 149 of Revised Order
...
the st andards set by the NTC for the industry during that time.
...
application of Section 32 141 of the DPA. The Decision dated 17
...
> preceding section without the consent of the data sub ject, shall he subject to imprisonment ranging from one (1) year to
...
innovation and growth – the underlying s tate policy behind the DPA
...
necessarily resor ting to the penalties under Chapter VIII of the DPA,
...
aggravating factor in the impositi on of fines and other liabilities. On
...
– the Public Service Act – which imposes the legal obligation to p ublish
...
informati on via the Directory Listing as part of the fulfillment of its
...
in the directory listing have not expressly provided their c onsent to
...
PLDT Group explained that it commenced addressing and
remediating this perceived “DPA gap” since 08 July 201 7 with the
...
2017 have been included in the directory listing by defa ult. PLDT
...
decide whether they want their name, address, and telephone numb er
...
Again, it must be stressed that the publ ication requirement emanates
...
prov iders are mandated to publish the telephone directory at
least once a year.
...
telephone directory, the te lephone public service provider shall
...
journeys of com panies with the DPA varied. This is because no one
...
company results from either a calculati on of costs and benefits or is
...
Even now, the NPC c ontinues to conduct awareness campaigns to
guide the PICs or PIPs. NPC have been leaders and protectors. And
enforcers, espec ially against those who willfull y violate the law. As
NPC advances, the Commission is urged to put on wider lenses when
adjudicatin g cases to enable the PICs to thrive and encourage
organizational accountability without fear of being put behind bars
while meting justice to data subjects.
Following the pre vious discussions, my recommendation is for this
Commission to partially grant t he Motion for Reconsideration filed by
PLDT.
...
their information would be published on the White Pages, the no minal
...
Thousand Pesos (P1 0,000.00). It must be stressed that the damages are
...
determining and identifying the responsible person s, officers, or
individuals of PLDT Enterprise should be SET ASIDE.
Instead, t he Compliance and Monitoring Division (CMD) of the
