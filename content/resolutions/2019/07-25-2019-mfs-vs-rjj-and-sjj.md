...
Assailed in this Motion for R econsideration 1 is the Decision 2 dated 19

March 2018 of the National Privacy Commission (NPC) which

declared that Respondents R JJ and SJJ did not violate Sections 25, 28,
...
access or intentional breach and malicious disclosure, all of which are

prohibited by the Data Privacy Act of 2012.

On 07 March 2017, this Commission received a Supplemental

Complaint Affidavit 3 alleging:

1. In June 201 6, I personally called RJJ’s mother to

talk about R JJ and SJJ accessing ou r credit

information and she ver bally confirmed that SJJ

is indeed looking into financial records, not only

of ours, but the records of even ano ther relative
...
that RJJ and SJJ also lo oked into my mother’s

credit information as they emphasized t hat they
...
2. It is unfor tunate that my name (SJJ ) is dragged
...
I really don’t know if BDO has sensitive
...
same because it is highl y confidential as stated

in his own very complai nt letter. I am just a
...
I h ave access to the computer system of BDO,
...
resp ondent RJJ was aware regarding their

unpaid credit cards.

9. At the ons et, I (RJJ ) do not have access to the
...
11. I (RJJ ) previously worked for various
...
Bank/Negative Data Base, and how the g eneral
...
is to fo rce me to sign on an affidavit of
...
2. During our m eeting with RJJ and SJJ , they

showed me a list of his employers in which he

has access to the Negative Data list. I took a

photo of the document he gave us. How ever,

upon reviewing RJJ ’ statements in his counter -

affidavit, I noticed that there is a clear o mission
...
parties concerned, this Commission rend ered its decision finding that
...
probative va lue. Not only must there be some
...
2018 decision of this Commission. Thereafter, Complainant file d its
...
Philippine Islands (BPI) A B Branch Assistant Manager VA verbally

confirmed that he is currently in the Negative Data List.

Additionally, Complainant provided a Facebo ok Messenger
...
the former of being an irresponsible payer based on a Negative Data
...
act ual access to the said negative data list.
...
Lastly, C omplainant MFS admitted that he was not a depositor of
...
Banks rendering his status irrelevant for th e issue on hand.
...
it containe d the very same issues, assignment of errors, and
...
Respondents argue that the Motion for R econsideration is defective

for fai lure to comply with requirements set forth under Sections 2, 4,
...
Substantial evidence is defined as such amount of rel evant evidence
...
to believe, based on the evidence submi tted, that the respondent is
...
cases, but the evidence must b e enough for a reasonable mind to
...
Supreme Court has reiterated time and again that i n administrative
...
access to person al information is not enough. Without supporting
...
had actua l access to the former’s personal information.
...
Respondent s accessed data that would show Complainant and his
...
Motion for reconsideration must be sufficient in form and in
...
Within the same period, th e aggrieved party
...
In his Motion for R econsiderat ion, Complainant merely reiterates his

arguments and assertions. He enumerates in the said motion his

verbal communication dated 27 February 2017 with BPI A B Branch

Assistant Manager VA , text message exchange with C omplainant
...
“Under our rules of procedure, a party advers ely affected by a
...
foregoing grounds is deemed pro forma if the same does not specify
...
pertinent evidence or l egal provisions.” 9
...
merely attempts to assert his claim in his Motion for R econsideration

by rehashing the pieces of evidence pre viously ruled upon by the
...
Although Complainan t’s Motion for R econsideration had some flesh
...
why reconsideration is warranted. The Supreme Co urt declared that it
...
for reconsideration pro for ma. 10
...
again, that under the aforementioned rule; mand atory is the
...
requirement in a mo tion. As a rule, a motion without notice of
...
On 13 February 2017, Complainant submitted his Complai nt
...
Respondent s to file their responsive pleadings and thereafter, the
...
“A mere claim that one ha s access to personal
...
personal information. A supposition cann ot in any
...
evidence and pleadings submitted by bot h parties. Allegations made

by C omplainant Salipot that no investigation of the privacy violation
...
investigating officer. The Supreme C ourt has ruled that, “w here the
