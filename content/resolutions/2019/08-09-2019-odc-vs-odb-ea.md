...
CAR DMEMBER hereby gives ISSUER and its Related Companies

full power and authority to implement the foregoing acts 8.
...
irrevoca bly authorizes ISSUER and/or its Related Companies to
...
order that the same may be u sed to satisfy any and all obligations
...
framework of the foregoing appointment 9.
...
the d ata subjects like the complainant, in the future. This was a
...
Therefore, this Commissi on stands by its decision that
...
information controllers s hould put themselves in the shoes of its
...
cli entele and should no longer rely on privacy policies or terms and
...
reasonable expectations of the user to be inf ormed and must go beyond legal
...
organizati onal accountability to the DPA. However, the presence of Privacy
...
understand and do not effectivel y explain the benefits, risks, potential harm,
...
applied it to this case, however, I respec tfully dissent.
...
“r espondent should have properly informed the complainant of its
...
data privacy as a new cog in already functioning mechanism s. Such a

position paves the way for creative litigants to weaponize the DPA for

purposes not germane to the intent of the l aw.
...
fac tual findings of the Commission, these findings are final as to him.
...
respondent ODB to have violated the principle of t ransparency and
...
Aside from the complainant’s bare assertion that he “d id not sign any
...
transparency does not also require personal i nformation controllers to
...
should not be phrased in abstract or a mbivalent terms or leave room for
...
understood by an ave rage member of the intended audience . Intelligibility is
...
(2) a desc ription of the personal information to be entered into
...
(5) methods utilized for automated access, i f the same is allowed
...
transparency. Expres sio unius est exlusio alterius.
...
deemed assigned to the ISS UER effective upon the occurrence of default. The
...
language,” there is no basis to find the 2013 vers ion as violative of the
...
real intent is eviden t, by using terms such as “automatically debit”,
...
account” as well as the other informati on being provided to them in
...
acknowledgment of the lack of full transpare ncy in the terms and
...
names and constitu tes ISSUER and/or its
...
subject in mind” as the m ajority claims.
