...
MVC v. D SL , R RB v. D SL ,

NMB v. D SL , R MP v. D SL ,

NDL v. D SL , and M BN v. D SL
...
April 2022 filed by DSL .

Facts

On 03 February 2022, the Commission issued a Decision finding DSL
...
the prosecution of DSL for the offense of Unauthorized
...
be hel d liable for Unauthorized Disclosure because as the President
...
members of GAT1CC, which included Complainants M VC , R RB ,

NMB , R MP , N DL , and M BN (Complainants), are bound by the

House Rules and Regulations of GAT1CC. 6 Thus, according to DSL ,
...
> 1NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, NPC 21 -015, 03 February 2022,
> at 13 (NPC 2022) (unreported).
> 2Motion for Reconsideration, 05 April 2022, ¶ 2, in MVL , et al. v. D SL , NPC 21 -010, NPC 21 -011,
...
He claimed that the Complainants failed to substantially prove that
...
[C] ondominium [C] orporation, and [DSL ] is the President of
...
> 8Motion for Reconsideration, 05 April 2022, ¶¶10 -11 ,in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -
...
cases with same issues a s the case at bar pending before various

courts. 13  To recall, DSL enumerated the following pending cases:

a.  SEC Case No. 01 -18 -463, J M et., al., vs. GAT1CC, D SL et., al.

[…]

b.  HSAC Case No. REM -050918 -16656 entitled R P, Selected

Homeowners of GA Tower 1 vs. D SL et., al. […]
...
d.  Injunction Case. GAT1CC vs. J R, R B et., al., RTC, BR. 211,

Mandaluyong City, Civil Case No. R -MND -20 -01767 -CV[.] 14
...
July 2022, the y manifested that the Commission should deny DSL’s
...
be considered as “a mere scrap of paper that produces no legal and
...
Memorandum, 06 October 2021, at 6, in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -011, NPC 21 -

012, NPC 21 -013, NPC 21 -014, NPC 21 -015 (NPC 2022).

> 15

Motion for Reconsideration, 05 April 2022, in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -011,

NPC 21 -012, NPC 21 -013, NPC 21 -014, NPC 21 -015 (NPC 2022).

> 16

Order, 28 April 2022, in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013,

NPC 21 -014, NPC 21 -015 (NPC 2022).

> 17

Consolidated Comment/Opposition, 08 July 2022, at 1, in MVC , et al. v. D SL , NPC 21 -010, NPC
...
Id. at 3. NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015
...
The Commission denies DSL ’s Motion for Reconsideration dated 05
...
> 21 Id.
> 22 Id.
> 23 Consolidated Comment/Opposition, 08 July 2022, at 3, in MVC , et al. v. D SL , NPC 21 -010, NPC
> 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, NPC 21 -015 (NPC 2022).
> 24 Id .
...
President [DSL ], was well within its right when it posted the
...
outstanding obligations. 29  It, however, ruled that DSL ’s processing

was neither necessary nor proportional to the alleged purpose:

> 25 Motion for Reconsideration, 05 April 2022, ¶¶ 8 -9, in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -
> 011, NPC 21 -012, NPC 21 -013, NPC 21 -014, NPC 21 -015 (NPC 2022).
> 26 Id. ¶ 11.
...
dues. Rather, the evidence on record shows that DSL disclosed
...
that there wa s indeed a processing that occurred, it is incumbent

upon the PIC th at process ed the personal data to prove that it is

either exempted from the scope of the DPA or that the processing
...
Trial C ourt that has jurisdiction over the case. 35
...
Contrary to DS L’s assertions, t he Commission did not commit an
...
> 33 Motion for Reconsideration, 05 April 2022, in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -011,
> NPC 21 -012, NPC 21 -013, NPC 21 -014, NPC 21 -015 (NPC 2022).
> 34 Id. ¶ 19.
> 35 Id. ¶ 22.
> 36 Id. ¶ 28.
...
The Complaints -Assisted Form s were filed on 15 January 2021, when
...
> 39 See Comment, 06 October 2021, Annexes 2 -8, in MVC , et al. v. D SL , NPC 21 -010, NPC 21 -011,
> NPC 21 -012, NPC 21 -013, NPC 21 -014, NPC 21 -015 (NPC 2022).
