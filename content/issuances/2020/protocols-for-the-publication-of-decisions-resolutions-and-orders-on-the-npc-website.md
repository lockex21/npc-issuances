...
**SECTION 1.** ***Scope of Publication.*** These guidelines shall cover all Commission Decisions, Resolutions and Orders issued by the Commission En Banc.

The following shall not be published on the NPC website:

1. Cases decided on the basis of compromise agreements, mediated settlement agreements, quitclaims and other modes of alternative dispute resolutions as these are not decided on the basis of merit and therefore lack teaching value for the public.
...
Notwithstanding the enumeration above, the Commission may, at its own discretion, publish Decisions, Orders and Resolutions where public interest warrants or for the education of the public.

**SECTION 2.** ***Modification Requirements.*** The Commission Decisions, Resolutions and Orders shall be prepared accordingly:

1. Two (2) versions shall be produced for each case. The first version retains the identity of the data subjects. The first version shall only be reviewed and stored within the Commission, forwarded to the parties in the case, and, if necessary, transmitted to other government agencies for appropriate action.
...
2. The second version shall pseudonymize the identity of the data subjects, with the following details being altered or removed as determined by the Commissioner in charge of preparing the second version:

   a. The complete names of data subjects shall be replaced with fictitious initials in all mentions within the case. This may either follow the initials of the data subject, or any combination of letters, so long as it will not identify, directly or indirectly, the individual or parties within the case.

   b. Whenever applicable, the disclosure of personal or sensitive personal information shall be limited so as not to place the parties at risk of harm. For instance, if the address is important in giving context to the case, only the province or city shall be included.

**SECTION 3.** ***Retroactivity.*** These guidelines shall apply retroactively for cases already published on the website.
