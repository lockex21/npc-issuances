...
**SECTION 1.** ***Scope.*** This Circular applies to any natural or juridical person operating in the Philippines—government or private—whose personal data processing falls under the [[laws/data-privacy-act-of-2012|DPA]], its [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012|IRR]], or other NPC issuances.

**SECTION 2.** ***Definition of Terms.*** All definitions from the [[laws/data-privacy-act-of-2012|DPA]] and its [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012|IRR]] are adopted. The following additional terms are defined to support registration, notification, and compliance:

A. **Automated Decision-making** means a wholly or partially automated operation that reaches decisions without human intervention, typically involving profiling.

B. **Common DPO** refers to a single professional appointed across related PICs/PIPs to ensure compliance with the [[laws/data-privacy-act-of-2012|DPA]], its [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012|IRR]], and other NPC issuances.

C. **Compliance Officer for Privacy (COP)** is an individual supporting a DPO within a specific region, office, or line of business.

D. **Data Protection Officer (DPO)** is the designated employee responsible for compliance; unless permitted otherwise, this person must be an organic employee, and no entity may register more than one DPO.

E. **Data sharing** denotes disclosure or transfer to third parties and, for PIPs, is allowed only upon PIC instruction or within a subcontracting arrangement.

F. **Government Agency** includes constitutional commissions, LGUs, GOCCs, GFIs, and state universities.

G. **Head of Agency/Organization** designates the individual or board authorized to manage the entity.

H. **Individual Professional** refers to a self-employed natural person who processes personal data and is considered the de facto DPO.

I. **Operating in the country** covers entities using Philippine equipment or maintaining a Philippine office, branch, or agency.

J. **Private entity/organization** refers to any non-government natural or juridical person.

K. **Profiling** means automated processing aimed at evaluating, analyzing, or predicting attributes, behavior, or preferences.

L. **Registration information** is the completed data entered into the NPC registration platform.
...
3. Guarantee that information about Data Processing System owned by PICs or PIP operating in the country are made accessible to the Commission to enable a more efficient compliance monitoring process and uphold the exercise of data subject rights under the [[laws/data-privacy-act-of-2012|DPA]]; and

4. Promote transparency and accountability in the processing of personal data.

**SECTION 4.** ***General Principles.*** This Circular is governed by principles that keep registration, interpretation, and confidentiality consistent with the [[laws/data-privacy-act-of-2012|DPA]], its [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012|IRR]], and NPC issuances:

A. Registration of a PIC’s or PIP’s Data Processing System and DPO is one of the means to demonstrate compliance.

B. Registration submissions are presumed complete for all active systems unless otherwise indicated.

C. DPO identity and contact information remain effective until an allowed amendment is submitted.

D. Submitted information remains confidential except where this Circular provides otherwise.

E. Interpretive doubts are resolved in favor of upholding data subject rights.
...
more persons, or those processing sensitive personal information of one thousand (1,000) or more individuals, or those processing data that will likely pose a risk to the rights and freedoms of data subjects shall register all Data Processing Systems.
...
Data Processing System or inaugural DPO in the NPC’s official registration platform within twenty (20) days from the commencement of such system or the effectivity date of such appointment.
...
through its designated DPO. A PIC or PIP shall only be allowed to register one (1) DPO, provided that in cases where a PIC or PIP has several branches, offices, or has a wide scope of operations, the PIC or PIP may designate one (1) or more Compliance Officers for Privacy (COP) who shall then be indicated as such in the DPO registration. Approval of the Commission is not required for COP designations.
...
An Individual Professional shall register himself or herself as the DPO. In cases where the Individual Professional contracts another person to act as DPO he or she shall indicate such

fact and provide the required contact details of such person in the registration record. The Commission through an Order may require a PIC or PIP to submit supporting documents related to this submission.
...
Registration in favor of a PIC or PIP, that has successfully completed the registration process. The Certificate of Registration shall only be considered as proof of such registration and not a verification of the contents thereof.
...
the grounds provided for under Section 35 of this Circular and upon service of a Notice of Revocation to the PIC or PIP.

**SECTION 15.** ***Verification.*** The Commission may, at any time, verify any or all registration
information provided by a PIC or PIP through its compliance check function. Through a privacy sweep of publicly available information, notices of document submission or during on-site examination of the Data Processing System, all relevant documents shall be made available to the Commission.
...
the payment of reasonable fees for registration, renewal, and other purposes in accordance with a schedule that shall be provided in a separate issuance.

**SECTION 20.** ***Imposition of Administrative Fines.*** A PIC or PIP covered by Mandatory
Registration who shall be in violation of the same, shall be subject to the corresponding fine in accordance with the Guidelines on Administrative Fines.
...
and PIPs, and of the Data Processing Systems, and designated or appointed Data Protection Officers in electronic format.

**SECTION 24.** ***Removal from Registry.*** The registration information of a PIC or PIP may be
removed from the registry, upon prior notice by the Commission, on any of the following grounds:
...
carries out any automated decision-making operation or profiling shall indicate in its registration record and identify the Data Processing System involved in the automated decision-making or profiling operation.
...
profiling shall be included in the registration information that will be provided by a PIC or PIP, as indicated in Section 12 of this Circular, or through amendments or updates to such registration information, as per Section 16 of this Circular, within the prescribed periods.

**SECTION 28.** ***Availability of Additional Information.*** Upon request by the Commission, a
PIC or PIP shall make available additional information and supporting documents pertaining to its automated decision-making or profiling operation.
...
displayed at the main entrance of the place of business, office or at the most conspicuous place to ensure visibility to all data subjects.
...
of Registration has been revoked, or the registration of the PIC or PIP has been validly withdrawn, the Seal of Registration shall automatically be revoked or otherwise invalidated.
...
A. failure to comply with any of the provisions of the [[laws/data-privacy-act-of-2012|DPA]], its [[laws/implementing-rules-and-regulations-of-the-data-privacy-act-of-2012|IRR]], or any relevant issuances of the Commission;
...
E. lack of capacity or inability to securely process personal data in accordance with the [[laws/data-privacy-act-of-2012|DPA]] as determined by the Commission thru its compliance check function;
...
**SECTION 40.** ***Repealing Clause.*** This Circular supersedes in its entirety [[issuances/undated/registration-of-data-processing-systems|NPC Circular No. 17-01]]. The provisions of the IRR and all other issuances contrary to or inconsistent with the provisions of this Circular are deemed repealed or modified accordingly.
