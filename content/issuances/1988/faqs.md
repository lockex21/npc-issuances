...
3. How can the NPC justify an ex parte CDO when the [[laws/data-privacy-act-of-2012|DPA]] does not authorize the NPC to    issue the same?
...
No, an aggrieved party or a data subject as contemplated by the [[laws/data-privacy-act-of-2012|DPA]] only refers to a    natural person, privacy being a fundamental human right. (Advisory Opinion No. 2017-006)    However, according to NPC Circular 16-04, a natural person may be represented by a    juridical person (Section 3).
