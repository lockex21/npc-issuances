...
## III.     ARE ACCREDITATION AND CERTIFICATION THE SAME?
         ...
         conformity assessment tasks. CBs undergo the accreditation process to certify PICs and  
         PIPs.

         Meanwhile, Certification refers to a third-party attestation related to an object of  
         conformity assessment (e.g., product, process, service, system, installation, project,  
         data, design, material, claim, person, body, or organization) with the exception of  
...
## IX.   WHAT HAPPENS IF PICs, PIPs, AND CBs FAIL TO COMPLETE THE REQUIREMENTS FOR CERTIFICATION OR ACCREDITATION UNDER
  ...
  X.     WILL THE APPLICATION BE CONSIDERED IF IT IS A TRANSFERRED ISO  
        CERTIFICATION?  
