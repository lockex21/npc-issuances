---
title: "CID 18-E-040: KGR v. BB et al."
description: "CID 18-E-040: KGR v. BB et al."
tags:
  - "decision"
  - "type/decision"
  - "year/2018"
...
-versus - CID Case No. 18 -E-040

For: Violation s of Sections 27, 28,
...
for which she paid P8.00. Upon checking he r resume, she noticed a
...
Thereaft er, o n 11 March 2018, Complainant and her mother went to
...
> 1Records, p. 2. CID 18 -E-040
> KGR v. BB , et al
> Page 2of 8
> 5th Floor, Delegation Building, PICC Complex , Pasay City 1307
> URL: http://privacy.gov.ph Email Address: info@privacy.gov.ph

“Sorry po talaga Ma’am nainis po kasi ako .” 2 Respondent AA , the owner
...
Blotter, and sent two (2) Memoranda to Respondent s requesting for a
...
Respondent was given ten (10) days from receipt of su ch additional
...
As I want to practice and fight f or my rights, I feel and am

already very exhausted mentally and emotionally. I a nd my
...
evidence and must be deemed to have waived her right to submit t he
...
information. In her Complaint, she state s that “everyone who entered

the shop can easily see her resume.” 7 She file d a criminal complaint for

violation of Sections 27, 28, 31, and 32 of the Data Privacy Act arising

from Improper Disposa l, Unauthorized Purposes, Malicious and

Unauthorized Disclosure of her sensitive personal information

without her prior consent and know ledge. 8
...
overrea ch the desk. To conclude, Complainant noticed her photo
...
from the custo mer area because the font is too small. In short,
...
(sic) any of those acts tha t would define them as personal

information controller or processor. Respondents are engage d in
...
discretion in the use of personal information of in dividuals , they are
...
processing of persona l data under any of the lawful criteria provided
...
as the filing of a complaint. They are further required to secure t he
...
general data privacy principles 13 of transparency, legitima te purpose,
...
> 11 R.A. 10173, §§ 12 -13.
> 12 Id ., at § 20.
> 13 Id., at § 11. CID 18 -E-040
> KGR v. BB , et al
> Page 5of 8
> 5th Floor, Delegation Building, PICC Complex , Pasay City 1307
> URL: http://privacy.gov.ph Email Address: info@privacy.gov.ph

processes information should process information only for legitimate

purposes that have been made known to the data subject . They should

only process as much information as is need ed to achieve their clearly
...
10 173 defined processing as “any operation any set of operations
...
modification, retrieval, consultation, use, consolidation, block ing,
...
was there modification, retr ieval, consultation, use, consolidation,
...
up to the disposal or erasure of personal data. A data life cyc le begins
...
un its and printing of paper works, 15 they nevertheless still handle

personal information in the course of their operations. Respondents

must bear in mind that the ir processing of such personal information

should only be for the purpose of delivering the services they provide .

In addition , Respondents’ apprec iation of the term “disposal” is also

misplaced. In their Joint Affidavit, they state:

Disposal mea ns “throwing away.” To set the record straight,
...
> 14 Records, p. 44.
> 15 Supra at note 1 0.CID 18 -E-040
> KGR v. BB , et al
> Page 6of 8
> 5th Floor, Delegation Building, PICC Complex , Pasay City 1307
> URL: http://privacy.gov.ph Email Address: info@privacy.gov.ph

Respondent BB pasted the resume portion on the CPU and not

“disposed.” 16

Contrary to what Responden ts assert, “disposal” is not limited to the
...
be considered “improper disposal” since it allow s the further

processing of th e personal data despite its purpose having already

been fulfilled. As stated above, personal data should only be processe d

for as long as necessary to achieve the stated purpose. Once that

purpose is achieved, the personal data should be d isposed of in a way
...
misconceptions, though not enough to merit a recomme ndation for
...
fronting a customer or customer area... a custom er cannot see what

was pasted on the CPU side unless the customer will get (sic) inside

the counter o r overreach the de sk .”17

Such fact is crucial in determin ing whether such posting was pursuant

to a legitimate business interest – that is, choosing who m to transact
...
who carr ies the burden of proving their allegations with substantial

> 16 Records ., p. 43.
> 17 Records, p. 43. CID 18 -E-040
> KGR v. BB , et al
> Page 7of 8
> 5th Floor, Delegation Building, PICC Complex , Pasay City 1307
> URL: http://privacy.gov.ph Email Address: info@privacy.gov.ph
...
Commission stat ing that she will no longer pursue the case. 20

The Commission is bound to adjudicate complaints following its Rule s
...
The Commissi on therefore resolves to dismiss the complaint for lack
