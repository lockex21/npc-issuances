...
Conference, the respondent s were directed to submit a responsive
...
Records , p. 46; see NPC Circular No. 16 -04, Rule III, Section 15. Decision
...
the incident s and arguments against the complainant’s allegation, and

attached as annexes a Privacy Impact Assessment (PIA) , DTR and

Payroll processes, attendance recor ds of the complainant, as well as
...
memb er of the CBMA, the Department Head of the Real Estate
...
Asia , inform ing WUT , president of the university, about alleged
...
declared no classes for re ason of fortuitous events and force majeure shall be paid
...
members, and erased the total number of da ys we reported. But for one of her
...
faculty members who were deducted from them but no deduction for Mr. KRL . Is

she at liberty to make a mockery of the provisions of the Labor Code? To apply the

law negatively to those employees, she doesn’t like and to apply the same

provisions positively to those employees, she likes? Are we changing now the core

values of [respondent university]? 4

Based on those statements, complainant conclude s that the

respondents were able to access his DTR and pay slip because they are

specific about the deductions and ha ve a strong conviction that he wa s
...
month of August 2017. 6 According to him, a s a Department Head, he
...
> 4Id., at p. 6-7. Emphasis in the original.
> 5Id .at p. 1.
> 6Id. at p. 117.
> 7Id. at p.118.
> 8Ibid.
> 9Id. ,at p.2.
> 10 Id., at p. 2. Decision
> CID Case No. 17 -K-003
> Page 4of 15
...
feels his right to privacy has been violated. 11  According to him, t he
...
which caused hi m dismay. 12  He asserts that as a human resource
...
should be confidential. 13  He state s that he has experienced sleepless
...
Appearance with Motion for Clarification of Procedure , argue s that the
...
Modes of Dispute Resolution, 16  it likewise raise s that the complain t

should have been referred to a Mediation Officer for assistance in

reaching an amicable settlement 17  since the complaint is devoid of any
...
processes, the DTR system is not one of them. The responden t
...
> 17 Records, p. 55.
> 18 Id., at p.55 -56.
> 19 Id ., At p. 92 -103. Decision
> CID Case No. 17 -K-003
> Page 5of 15

The r espondent university asserts that consent of data subjects is
...
2.  On every cut -off date (the 15 th and 20th of the month), the
...
class beadle/president t o submit the DTR of the faculty concerned to

the College Clerk; or (f) course it through the Student Apprentice

available. 23

The respondent university den ies that the professors illegally

access ed complainant’s pay slip. According to them, t he payroll
...
timely and appropriate action on the claimed privacy vi olation or
...
> information was given and exposed to an dby the faculty members. 25

Nevertheless, the following exchange during the discovery

conference show s that there was an attempt to comply with the

requirement of exhaustion of administrative remedies:

> KRL :Your honor just to answer that, Iapproach NPC on
...
Act, taking into account the risk of harm to the af fected data subject.
...
The DPA provides that p ersonal information is any information,
...
information would direct ly and certainly identify an individual. 36
...
provided by the DPA for person al or sensitive personal information,
...
> 37 NPC Advisory 2017 -03. Decision
> CID Case No. 17 -K-003
...
privacy risks associated with the m, and identify the measures needed
...
which personal information is handle d, a personal information
...
stated the existence of organizational, physical, and techn ical

measures in place for the DTR system . After this, however, t he
...
practices” of the faculty regarding their subm ission of DTRs .38  The
...
the DTRs are transmitted through different routes 43  that deviate from
...
> 42 Id., at p. 116.
> 43 Supra note 24.
> 44 Supra note 22. Decision
> CID Case No. 17 -K-003

Nowhere in the respondent university’s submitted PIA were

these practices even mentioned, despite the fact that t he se should been

considered as compliance gap s resulting in privacy risks that needed
...
systems for the protection of its stakeholder’s privac y.
...
The lack of either a uni form policy or process that covers the
...
> 45 SEC. 26. Accessing Personal Information and Sensitive Personal Infor 2mation Due to
...
> to personal information without being authorized under this Act or any existing law. Decision
> CID Case No. 17 -K-003

it. 46  This color of authorit y to access the DTRs, with the acquiesce nce
...
not reasonably expect further processin g. 47  That cannot be said to be
...
“reasonable expectation” is considered in determin ing the legitimacy
...
Having discussed respondent professors’ initial access, t he next
...
in their letter -complaint about Dea n CS .
...
holiday pay . To the respondent professor s’ personal knowledge, the

complainant was the only faculty member who did not re ceive
...
personal information controller o r by a third party or parties to whom
...
Th e DPA is not intended to cover every possible infraction in the
...
the objective of th at letter -complaint was to inform the President of
...
avail able to him under existing laws, although not the DPA. The merits
...
complainants pay sli p to warrant a
...
Th e complainant’s allegation in relation to his pay slip remains
...
and do the computation” and that “no other department co mputes the
...
violation of the Data Privacy Act on the part of the r espondent s Trinity

University Of Asia , AA, MC, NCB, RG GV, GCT, RR, MR, PB , to

warrant a recommendation for prosecution . T he complaint filed by
