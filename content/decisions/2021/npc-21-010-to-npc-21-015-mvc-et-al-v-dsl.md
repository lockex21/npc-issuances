...
description: "2012 NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015"
tags:
  - "decision"
  - "type/decision"
  - "year/2021"
...
2012 NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015
...
(GAT 1CC). 2 DSL , allegedly as the President of GAT1CC , published a
...
> 1Complaint -Assisted Form, 08 June 2018, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC
...
a magazine distributed to other unit owners .5 Complainants assert that
...
It also maintains that it s Master Deed states that assessments for
...
> 5Id.
> 6Id.
> 7Complaint -Assisted Form, 08 June 2018 ,in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC
> 21 -014, and NPC 21 -015 (NPC 2021) (pending).
> 8Id.
> 9Order to Comment, 2 1July 2021, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014,
...
particularly but not by way of limitation, common expenses
...
the condominium buildin g and its facilities. All interests are
...
On 28 September 2021, the Commission ordered the parties to submit
...
Deed, By -Laws, and its House Rules and Regulatio ns. 21
...
faith and malic e and had no authority to post the letter dated 23
...
assessments, whether the unit con cerned is occupied or not

> 18 Order, 28 September 2021, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and
> NPC 21 -015 (NPC 2021) (pending).
> 19 Memoranda(Consolidated), 08 October 2021, at 13 -14, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC
> 21 -013, NPC 21 -014, and NPC 21 -015 (NPC 2021) (pending).
> 20 Id. at 12 -19.
> 21 Id.
> 22 Id.
> 23 Memorandum by RRB , 11 October 2021, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC
> 21 -014, and NPC 21 -015 (NPC 2021) (pending), Memorandum by NMB , 11 October 2021, in MVC , et al. v. DSL , NPC 21 -
> 010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015 (NPC 2021) (pending), Memorandum by RMP ,
> 11 October 2021, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015
> (NPC 2021) (pending), Memorandum by NDL , 11 October 2021, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -
> 012, NPC 21 -013, NPC 21 -014, and NPC 21 -015 (NPC 2021) (pending), Memorandum by MBN , 11 October 2021, in MVC ,
> et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015 (NPC 2021) (pending).
...
in G A Tower I’s premises since the contents of the notices cannot be
...
publi shing the letter dated 23 November in a magazine distributed to
...
construed as processing based on lawful criteria under Sectio n 12 (c)
...
it performed , and that the processing is necessary to comply with the
...
case , it is the collect ion of unpaid dues provided under a valid contract

with its unit owners .

While it is necessary to process the delinquent unit owner s’ personal

information in order to assess and collect payments pursuant to a

contract , the processing in the form of issuing the letter was n either

necessary nor proportional . The purpose of the letter was not for the

collecti on of delinquent dues . Rather, the evidence on record shows

that DSL disclosed Complainants’ personal information as delinquent

unit owners to c as t doubt on their capability to manage the affair s of
...
aspiring to become members of the Board, what will happen
...
of the condominium corporation is not su ff icient. Had it truly been on
...
data sub ject, shall be subject to imprisonment ranging from
...
> 28 Complaint -Assisted Form, 08 June 2018, Annex, in MVC , et al. v. DSL , NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -
> 013, NPC 21 -014, and NPC 21 -015 (NPC 2021) (pending).
> 29
...
be presumed. 33  In this case, t he evidence on record do es not show that
...
> 31 Id. § 31.
> 32 Id.
> 33 Cruz v. Intermediate Appellate Court, G.R. No. 66327 (1984).
...
Thus, i t was incumbent upon Complainants to prove their claim that
...
Since a literal reading of Section 32 of the DPA will result in absurdity,
...
This interpretation benefits the accused since it narrows the extent to
...
1.  FINDS DSL liable for Section 32 (Unauthorized Disclosure) of

the Data Privacy Act of 2012; and
...
Complainant NPC 21 -010, NPC 21 -011, NPC 21 -012, NPC 21 -013, NPC 21 -014, and NPC 21 -015
