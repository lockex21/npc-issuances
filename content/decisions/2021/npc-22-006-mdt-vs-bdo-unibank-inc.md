...
description: "> 3Id . > 4Id . > 5Complaints -Assisted Form dated 26 January 2022 of MDT > 6Id . > 7Id . > 8Id .Exhibit “A” > 9Complaints -Assisted Form dated 26 January 2022 of MDT > 10 Id . > 11 Id . > 12 MDT v. BDO ,NPC 2 2-006 , Order to File Verified Comment dated 11 February 202 2, at..."
tags:
  - "decision"
  - "type/decision"
  - "year/2021"
...
call from JAC JAC (Caller ) on 04 November 2021 who introduced
...
personal data .24  Th us, MDT stated that his personal data that were

provided to BDO was unlawfully access ed and used by the caller to
...
associated with the subject transaction .31  MDT also praye d for the
...
BDO manifested that MDT has provided the expiration date, and CV V
...
On 22 June 2022, an Order after the 2 nd Preliminary Conference was
...
inciden t, it does not automatically cancel the subject transaction since
...
obligation on their part. 73  Thus, BDO pray ed for the dismissal of the
...
MDT alleged that BDO sh ould be penalized for violating Section 26 of

the DP A since BDO is the only one who should have access to his
...
information woul d directly and certainly identify an

individual. 95

Further, in this case, there is no s ensitive personal information present
...
Section 3 (I) of the DPA is present in this case. I t should be concluded
...
information”. 98  Hence, th e details found on a credit card such as credit
...
section without the consent of the data subject, shall he su bject
...
As to the four th element, there is no evidence to prove that there was

a disclosure of BDO to a third party. There is no unwarranted nor false

information disclosed, as provided by the fifth element. The re is no
...
The purpose of presenting the audio recor ding is to prove that there
