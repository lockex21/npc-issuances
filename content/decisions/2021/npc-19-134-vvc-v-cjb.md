...
the O fficer -in -Charge Provincial Environment and Natural Resources
...
she was appointed by the C ivil Service Commission (C SC) as a Land

Ma nagement Officer. 4 CJB denied VVC ’s request. 5

> 1Affidavit Complaint, at 1 ,in VVC v. CJB , NPC 19 -134 (NPC 2019).
> 2Id.
> 3Id. Annex A .
> 4Id. at 1.
> 5Id.
...
On 05 December 2018, CJB issued Special Order No. 12 -069 creating a
...
improbability , and credibility of the official records of employmen t
...
incredibility of [h er] official records of employment and school
...
3. The PDS states that VVC was employed by the DE NR from July
...
the school awarded h er a Degree in Political Science ;

5. It would have been improbable for VVC to attend h er classes and

report to DE NR at the same time throughout the 4 -year period
...
> 6Id.
> 7Affidavit Complaint ,supra note 1, Annex C.
> 8Id. at 1 .
...
employees to secure prior clearance from the DENR Secretary in
...
dishonesty bas ed on h er personal files. VVC maintains that her
...
On 05 July 2019, CJB , through counsel , filed hi s Entry of Appearance
...
On 07 August 2019, VVC filed her Answer to the Respon si ve Comment

in response to the Comment. 22 VVC asserted that the release of her P DS

to offices outside the DENR violated her rights as a data subject

because it contain s sensitive personal information and made her
...
released her P DS without her consent. 27
...
> 17 Entry of Appearance with An U rgent Motion for Extension of Tim e, 05 July 2019 ,at 1 ,in VVC v. CJB , NPC 19 -134 (NPC
> 2019) .
...
Complaint pursuant to Section 4 (a) of NPC Circular No. 16 -04
...
> 29 National Privacy Commission, Rules on Procedure of the National Privacy Commission ,Circular No. 04 , Series of 201 6
> [NPC Circular No. 16 -04] ,§4 (a) (15 December 2016 ).
> 30 AC Nv. DT,NPC Case No. 18 -109 (2021).
> 31 NPC Circular No. 16 -04, §4.
> 32 FG P v. M aersk ,NPC Case No. 1 8-038 (2020).
> 33 Answer to Responsive Rejoinder, supra note 26, at 1.
> 34 MNLC v. P XXX , et al., NPC Case No. 19 -528 (2020).

NPC 19 -134

> 5th Floor, Philippine International Convention Center, Vicente Sotto Avenue, Pasay City, Metro Manila 130 7

Data Priva cy Act of 2012, taking into account the risk of harm to
...
iii. or the action of the respondent is patently illega l. 35
...
contemplate exerc ises in futility that only delay justice for data subjects

whose rights are supposedly violated. 36

Given all these , the Commission waives the procedural technicalities

cited by CJB and proceeds to determin e if CJB violated  Section 25
...
qualifications, and eligibility 38 , which necessarily includes personal
...
> 35 National Privacy Commission, 2021 Rules on Procedure of the National Privacy Commission, Circular No. 0 1, Series of
> 20 21 [NPC Circular No. 21 -01], Rule II, §2(28 January 20 21 ). Emphasis supplied.
...
entity holding the information, or when put together with o ther
...
of a person, or to any proceeding for any offense committ ed or
...
Further, t he PDS contains an explicit authorization to allow the agency
...
statemen t pursuant to the provisions of pertinent laws, rules and
...
and privileged information shal l be prohibited, except in the
...
by w ritten, electronic or recorded means. It may also be given
...
informed indication o f will; and (4) evidenced by written, electronic or
...
occasion to state in Development Bank of the Philippines v. P erez :

... In discussing the consequences of a contract of adhesion, we

held in Rizal Commercial Banking v. C ourt of Appeals :
...
and is red uced to the alternative of taking it or leaving it,
...
> 46 Id.
> 47 Cabanting v. B PI Family Savings Bank, Inc. ., G.R. No. 201927 (2016).

NPC 19 -134

> 5th Floor, Philippine International Convention Center, Vicente Sotto Avenue, Pasay City, Metro Manila 130 7

freely gave her consent to the processing of her personal and sensitive
...
the processing of her personal and sensitive personal i nformation. By
...
and a fine of not less than Five h undred thousand pesos
...
than Four million pesos (Php4,000,000.00) shall be imposed
...
Informatio n is committed when the following requisites concur :
...
In this case, CJB processed VVC ’s pers onal and sensitive personal
...
Nevertheless, t he processing was done with the consent of VVC since
...
A strict and literal reading of Section 32 of the DPA on Unauthorized

Disclosure shows that a personal inf ormation controller ( PIC ) or
...
Section 32 of the DPA on Unauthoriz ed Disclosure should also not be
...
must be inter preted with reference to the context, i.e. , that
...
Sections 12 and 13 show that consent is but one of the lawful criteria

for processing. The presence of any of the criteria listed in either

section is sufficient to just ify the processing of personal or sensitive
...
interpretation benefits the accused since it narrows the ex tent to which
...
> supplied.
> 56 People v. L iban , G.R. Nos. 136247 & 138330 (2000). NPC 19 -134
> 5th Floor, Philippine International Convention Center, Vicente Sotto Avenue, Pasay City, Metro Manila 130 7

Here, CJB disclosed VVC ’s personal and sensitive personal
...
false informatio n since true, correct, and complete information should
...
as VVC ’s direct supervisor in order to verify or validat e the contents

of the PDS. 58 Finally, VVC consent ed to the disclosure of the
...
12 or 13 of the DPA is a common requisite of Section s 25 and 32 of the
...
32 of the D PA and the Complaint against CJB must be dismissed.
