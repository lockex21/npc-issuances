...
description: "> 1Letter from NFM to BPI ,02 January 2019, at 1, in NFM v. Bank of the Philippine Islands Family – > Credit Card Division, NPC 19 -1273 (NPC 2019). > 2Complaints -Assisted Form, 17 September 2019, at 3, in NFM v. Bank of the Philippine Islands > Family –Credit Card Division,..."
tags:
  - "decision"
  - "type/decision"
  - "year/2021"
...
> 1Letter from NFM to BPI ,02 January 2019, at 1, in NFM v. Bank of the Philippine Islands Family –
> Credit Card Division, NPC 19 -1273 (NPC 2019).
> 2Complaints -Assisted Form, 17 September 2019, at 3, in NFM v. Bank of the Philippine Islands
...
re ferred to Lazada’s Payment Team. 7
...
(P hp 11, 790.00) .8 BPI explained that :
...
BPI reiterated that an OTP can be received only by one w ho has access

to the registered mobile number. 10 BPI concluded that the

circumstances show that the transaction w as only made by NFM or by
...
> 4Complaints -Assisted Form, 17 September 2019, at 5, in NFM v. Bank of the Philippine Islands
> Family –Credit Card Division, NPC 19 -1273 (NPC 2019).
> 5Id.
> 6Letter from NFM to BPI ,01 March 2019, at 1, in NFM v. Bank of the Philippine Islands Family –
> Credit Card Division, NPC 19 -1273 (NPC 2019).
> 7Id.
> 8Letter from BPI to NFM ,09 January 2019, at 1, in NFM v. Bank of the Philippine Islands Family –
> Credit Card Division, NPC 19 -1273 (NPC 2019).
> 9Id.
> 10 Id.
> 11 Id.
...
On 10 January 2019, NFM wrote a nother letter to BPI disputing the BP I

Fraud Control Team ’s decision .14 In the letter, NFM reiterated that she

ha d nothing to do with the transaction. 15 She also claimed that she
...
Lazada using her credit card. 17 She also requested the fo llowing
...
of the item, and ( 6) the recipient of th e items purchased. 18 NFM also
...
form about the mobile update is given to the owne r of the account.” 19
...
alleg ed  that because  of the unauthorized transaction,  BPI processed
...
NFM pray ed for the reversal of payment with interest of the
...
complaint, together with any suppor ting documents the respondent
...
to file a responsive comment .30 BPI explained that it need ed to review
...
of Time to File a Responsive Comment and ask ed for an additional ten
...
On 15 January 2020, BPI filed it s Comment. 34 BPI refuted NFM‘s claim
...
conditions she acceded to during card application. Hence, it i s
...
someone h ad possession of the credit card at the time of the

transaction.

. . .

> 30 Urgent Motion for Extension of Time to File Responsiv e Comment, 16 December 2019, at 1, in
...
Thus, BPI pray ed that the Commission dismiss the complaint outright
...
NFM denied any involvement in the disputed transaction .43 She stat ed
...
transacti on in her credit card, but also the failure of BPI to secure her
...
additional information on the circumst ances surrounding the change
...
> Division, NPC 19 -1273 (NPC 20 21 ).
> 50 Id.
> 51 Id.
...
evidence that a reasonable mind might accept as adequate t o support
...
Burden of evidence is the duty of a party to pres ent evidence
...
proceedings, depending on the exigencies of t he case. 59

Th us , it is the party who alleges a fact that has the burden of proving
...
prove through the same screenshot that her history of purchas es in
...
> 59 2019 AMENDMENT TO THE 1989 REVISED RULES ONEVIDENCE ,A.M. NO.19 -08 -15 -SC , Rule 131, § 1
...
from different people that th eir mobile numbers were also allegedly
...
online transact ions, went to the Bangko Sentral ng Pilipinas (BSP) and
...
provide evidence to categ orically substantiate her claim s that a breach
...
allow ing changes to her mobile number.
...
and speculation cannot be given c redence. 69
...
Further, a s part of its security measures at the time the incident took

place, BPI implement ed a multi -factor authentication method to verify
...
c. 3-digit CVC printed on th e back of the card; and
...
(PIC s) of their continuing obligation to ensure that the personal data
...
security implementation. Subjec t to guidelines as the Commission
...
of their functioning o r availability;
...
In this case, the security measure s implemented by BPI involved
...
have ensure d that any changes to this number was also properly

verified and au thenticated to secure the integrity of the two -factor
...
Thus, this Commission finds that the award o f nominal damages to
...
party, but also denotes a correlative right on the o ther. 78 Since there is
...
Thus, a s a recognition and vindication of this right, this Commission
...
22 -01 or the Guidelines on A dministrative Fines, the Commission
...
> 75 Id.
> 76 An Act to Ordain and Institute the Civil Code of the Philippines [N EW CIVIL CODE ], Republic
...
AFFA IRS AND DISPUTE RESOLUTION DIVISION
