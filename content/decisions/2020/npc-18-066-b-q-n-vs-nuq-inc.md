---
title: "NPC 18-066: B.Q.N. vs NUQ Inc"
description: "Order of the Regional Trial Court, Branch 94 of Quezon City, dated 06 February 2018 :"
tags:
  - "decision"
  - "type/decision"
  - "year/2020"
...
## Source
- Reference: NPC 18-066
- Official PDF: http://privacy.gov.ph/wp-content/uploads/2023/05/NPC-18-066-B.Q.N.-vs-NUQ-Inc.-Decision-2020.05.21.pdf
- Source page: http://privacy.gov.ph/decisions-2/
- Issue date: May 21, 2020
- Published on NPC site: Wed, 24 May 2023 04:53:10 GMT
- Pages: 8

## Source Tags
- Not all processing and disclosure of personal information are violations of the DPA, criteria for lawful processing, processing of personal information shall be permitted only if not otherwise prohibited by law, processing of information is permissible if the processing is necessary for compliance with a legal obligation to which the personal information controller is subject, principles of transparency, legitimate purpose, and proportionality
...
Before this Commission is a c ase filed by B.Q.N. (Complainant ) against

NUQ INC., doing the business under the name and style of HQ , N.S. , N.U. ,

D.B.L. And S.K.D. (Respondent s) for the violation of Data Privacy Act
...
A court order 1 has been issued to Respondent s
...
However, Respondent s allegedly submitted a
...
As prayed for by Atty. S, let subpoena duc es tecum ad testificandum be issued to Winston Beltran,
...
January 2017 up t o January 2018 and to testify thereon on the said date.

(For violation of Data

Privacy Act of 2012) NPC 18-066

> B.Q.N. vNUQ INC , et al.
> Page 2of 8
> 5th Floor, Philippine International Convention Center, Vicente Sotto Avenue, Pasay City, Metro Manila 1307
...
On 11 September 201 8, parties were ordered to confer for discovery.

However, through email, Respondent s asked for its postponement.
...
Respondents explained that t he disclosure of personal information
...
a validly issued court order 2. The compliance thereto will necessarily
...
the D PA , its implementing rules and regulations, and other issuances

of the Commission.

On 18 October 2018, Complainant submitted her Re ply. She argue d
...
while also stating in the same pleading that both the dr iver and the
...
driver when in fact the certification it issue d in the name of
...
This c omplaint l acks merit and hence , the Commission adjudged its
...
controller (PIC) processe d the information of K.H.Q. to comply with
...
processing and unauthorized disclosure becaus e the personal
...
Complainant’s information in this ca se , are violation s of the DPA . I t
...
(a) The data subject has given his or her consent; NPC 18-066
...
obligation to which the personal info rmation controller is
...
require protection under the Philippine Constitutio n.
...
In this case, t he legal obligation of Responde nts arose from the
...
Section 9. Failure by any person without adequate cause to
...
created an obligation arising from law 3 on the part of Respondents in
...
required to submit a Certification 5 containing all the details required

in the subpoen a. Ergo,  Respondents cannot be faulted in processing the
...
allowing disclosure of info rmation to the public, and

adherence to the principles of transparency, legitimate

purpose, and proportionality.

The Rules 6 then subject s the processing of data with DPA compliance
...
proportionality 7, it provides that:
...
e. Breakdown of the number of rides, fares and in centives earned by K.H.Q. from January 2017 to

January 2018.

> 6

Section 1 8 of the Implementing Rules and Regulations of the Data Privacy Act of 2012

> 7

Section 18 ( c) of the Implementing Rules and Regulations of the Data Privacy Act of 2012 NPC 18-066
...
The aforesaid p rinciple then states that when assessing the processing
...
Respondents only processe d and collected the information required in
...
number of rides, fares, and incentives that are ind icated in the mobile
...
information even when responding to a legal obligation. Respondents NPC 18-066

B.Q.N. v NUQ INC , et al.

> 5th Floor, Philippine International Convention Center, Vicente Sotto Avenue, Pasay City, Metro Manila 1307

should always be  mindful of the rights and interests of the individual

about whom personal information is processed 8.

WHEREFORE, premises considered, the case NPC 1 8-066 “ B.Q.N. vs.
...
NPC 17 -047 , Decision, National Privacy Commission. NPC 18-066
