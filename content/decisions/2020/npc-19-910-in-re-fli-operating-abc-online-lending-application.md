...
- Published on NPC site: Wed, 24 May 2023 04:39:53 GMT
- Pages: 42
...
which identifies “bringing in an d using mobile phones by
...
legal counsel, QG Law Offices, which st ates that out of 69
...
After due consideration of the evidence presented as o f the date of
...
firm of DSBMR dated 21 September 2020, which state d:
...
The Commission likewise noted the Entry of App earance with Urgent
...
the Hearing, the Commission issued an Order dated 01 October 202 0
...
• Authorizing ML , Pres ident, on behalf of FLI Lending, Inc.,
...
General Manager, Gen eral HR Manager, and other officers
...
the Compliance filed by FLI Lendi ng, Inc. on 20 February, 2020,
...
6. Documenta tion on the number of CSA employees terminated as
...
c. FLI and CSA Ma ster Service Agreement with Confidentiality
...
In the Answer filed by Respondents FLI , ML , CW , and BSJ , the y
...
Finding Report d id not consider the side of FLI .16
...
and Monitoring, Complaints and Investigation, and Enf orcement

powers 17 to enable it to protect the fundamental human right of
...
Commissi on, sua sponte, or persons who are the subject of a
...
their right t o due process, this Commission provided Respondents an
...
even lose the basis for the instant case, which was su pposedly
...
wou ld investigate the same circumstances and cases. The Fact -
...
51. Th us , the reasonable approach would be to let the individual
...
case on hand involve different parties, different causes of ac tion with
...
criminal liabilit y, thus:

Sections 11, 12, 13, 16, 20, and 21 of the DPA cannot be the basis

for criminal prosecution. The Honorable Commission could h old
...
settle ment of complaints through the use of alternative dispute
...
the substantive bas es for determining violatio ns under Chapter VIII
...
informatio n and sensitive personal information ;
...
information of the data subject s.
...
prof essional associations and registration numbers, information about
...
gender, date of birth and nationality of the borrowe rs , on the other

hand, are considered sensitive personal information under the

enumeration provided in the DPA. 27

The DPA enumerates a series of processing activities to emphasize t hat
...
consultation, use, consolidation, block ing, erasure or destruction of
...
> proceedings, or the sentence of any court in such proceed ings;
...
without being authorized under th e
...
(b) The processing of personal information i s necessary and is related to the fulfillment of a contract

with the data subject or in order to take steps at the request of the data subject prior to entering

into a contract;

(c) The processing is necessary for compliance with a legal obligation to whi ch the personal
...
(f) The processing is necessary for the purposes of the legiti mate interests pursued by the personal
...
(b) The processing of the same is provi ded for by existing laws and
...
criteria. I n its Answer , it argued that it has obtained the consent of the
...
phone number, mobile phone number, financial inform ation, credit
...
and secured from unauthorized access, bre ach, disclosure or sharing.
...
organizations and their associations: Provided, That such processing is only confined and re lated to
...
the data subject was obtained prior to processi ng;
...
(f) The processing concerns suc h personal information as is necessary for the protection of lawful
...
(iv) financial information ne eded to process loans and payments, such
...
your pre ferences, such as your preferred methods of communication and
...
provided in the credit agreement is false, invalid or ot herwise
...
to the Cred it Agreement and Disclosure Statement. Thus, the
...
Th is issue has been clarified in the Commission ’s Advisory Opinions,

thus:

[T]here is also a need to determine and clari fy the distinction
...
be exercised. Any informatio n and communication relating to
...
the purposes of processing his or her personal data has differe nt
...
personal, or privileged informat ion.
...
informat ion as required under the law.
...
data subject is not empower ed to make a true choice. 34
...
its r etention of contact lists
...
other apps once installed on an Android device. Th ru the

android.permission.READ_CONTACTS permission, ABC app is

capable in reading the use r’s contact data; thru the
...
examination of the phone contact list to see if the phone i s newly
...
37. It may also be note d that the access of FLI to the contacts of the
...
application, whether the mobile p hone was newly purchased in the

event of a few entries in the contact list . This is part of their verification

process which is done prior to the approval of the loan. T he issue
...
which must also be supported by consent or other la wful criteria.
...
controllers, such as Respondent, t o inform their data subjects of
...
terms or leave room for different int erpretations. 39

The cited Privacy Policy in Respondent FLI ’ Answer also cannot be the

basis for acquir ing consent to retain the borrowers’ entire contact lists.
...
princip les of transparency, legitimate purpose and
...
demonstrates that the measures employed by Respondent FLI we re

disproportionate to the aim they s ought to achieve.
...
cannot be taken as a b lanket authority for excessive collection and
...
geographical location of the users the Global Posit ioning System
...
Case No. 19 -B-056 filed against ABC . Compla inant alleges that
...
of loan collection, in case the borrower himself is un responsive
...
reasonably assume that these third parties w ould be engaged in
...
Privacy Act, t his concept of “reasonable expectation” may still be
...
reasonably expect as to the purpos e, scope, manner, and extent
...
extent of Respondent FLI ’ proce ss ing of their information in the first
...
“collection pu rposes” in the Privacy Policy likewise does not
...
pe rtains only to the reference contacts supplied upon the loan
...
except for circumstances pro vided in the same Memorandum. It also
...
Respondent FLI , for good measure, states that even if there w ere acts

of unauth orized process ing, these cannot be attributed to Respondent
...
da ta subjects (i.e., beyond the consent they had given to FLI ) but
...
Respondent FLI cannot be abso lved of the violations of the DPA on the
...
Compli ance submitted by FLI , specifically the slide about the “ABC
...
• LEGAL. Evaluate s contracts and helps QA with inspections
...
“Collector” department had a supervisor to whom reports we re
...
tra nsfer or disclose personal information on his or her behalf. ”
...
information controll er is responsible for personal information
...
information or sensitive personal i nformation; and
...
Although seemingly similar, the application of principles in st atutory
...
various meanings, its correct construct ion may be made clear
...
phrase must be ascertained from the context of the body of t he
...
In this case, the dangerous permissions in the ABC applicatio n allowed
...
he or she shall, in addition to the p enalties herein prescribed, be
...
of this Act, he or she sh all, in addition to the penalties prescribed
...
unauth orized disclosure of personal information of the app
...
a ground fo r criminal liability.

The Supreme Court has consistently de fined gross negligence as “the
...
inform ation controller may subcontract the processing of
...
personal information proc essed, prevent its use for
...
that they sh ould have exercised as the Personal Information Controller
...
that they were not aware of a specific instance o f an action taken by
...
of com plaints filed b efore the Commission. These Disciplinary Report
...
re sponsibility in preventing unauthorized processing by its
...
involved dire ctly or indirectly with respondent FLI management
...
have allowed the all eged commission of the acts complained of. 65
...
has caused the corporation to co mmit acts in violation of the
...
to the civil liabilities of such co rporation
...
ensure compliance wit h the law and, if they fail
...
it command s. A necessary part of the definition
...
punishment therefor, it create s a criminal
...
are benefited by t heir delictual acts is not a
...
permissions . They were the ones who lack ed supervision over the

representations it made to all of FLI ’ borrowe rs .
...
of the R espondents for the crime s of Unauthorized Processing
