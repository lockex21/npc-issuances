---
title: "19-653: BGM vs. IPP"
description: "“Hi good evening. I’m sorry for what happened. Thank you so much sa tulong mo malaking"
tags:
  - "decision"
  - "type/decision"
  - "year/2019"
...
## Source
- Reference: 19-653
- Official PDF: http://privacy.gov.ph/wp-content/uploads/2023/05/NPC-19-653-BGM-vs-IPP-Decision-FINAL-Pseudonymized-21Dec2020.pdf
- Source page: http://privacy.gov.ph/decisions-2/
- Issue date: July 17, 2019
- Published on NPC site: Wed, 24 May 2023 04:39:06 GMT
- Pages: 10

## Source Tags
- Data subject’s right to access, criteria for lawful processing of personal information, legitimate interest, purpose, and proportionality, DPA should not be seen as curtailing the practice of law in litigation, restitution for the aggrieved party, and nominal damages
...
provided by Re spondent. Complainant then pro ceeded to the
...
Privacy Act of 2012) NPC 19-653
...
complainant must fi rst secure a police blotter and a court

order. On the same day, Complainant went to the MOA Police

Community Precinct to file a police blotter of the incident.

Thereafter, Complainant received a text message 1 from the

seller’s alleged mobile number s aying that she used the
...
alleg edly defrauded them thus prompting her to file the instant
...
psco. Pinapangako ko yan sau. At dodoblehin pa 2 ni lord. Ung binayad m kc kinuha ko lang din

sa remittance center. Salamat ulit. God bless.”

> 2

Section 16 (c) of DPA provides:

(c) Reasonable access to, upon demand, the following:

(1) Contents of his or her personal information that were processed;

(2) Sources from which pers onal information were obtained;
...
(6) Information on automated processe s where the data will or likely to be made as the sole basis
...
(8) The de signation, or name or identity and address of the personal information controller; NPC 19-653
...
officer to divulge the same . Respondent and Complainant were then
...
involve a violation under the D PA . Further, Respondent argued that
...
of violating the data privacy rights of t he data subject involved as well
...
acts would embolden scammers from using their servi ce, knowing that
...
data subjects under the DPA. Fu rther, Complainant assumes that by
...
part to protect her property from fraud. Complainant reiterated that to NPC 19-653
...
allow Respondent to decline from disclosing information needed, such

as in the instant Complaint, would effectively preve nt other similarly
...
Whether or not R espondent’s act of requiring Complainant to
...
16, paragraph (c) of the DPA, as follow s:
...
(4) Manner by which s uch data were processed;
...
significantly affecting or will affect the data subject; NPC 19-653
...
interpretation and should therefore be applied in its litera l meaning.
...
vested by the D PA to the latter as a data subject.

Further, R espondent ’s assertion that the information within its

custody can only be disclosed upon data subject’s consent or on the

basis of a lawful order is misplaced. NPC 19-653
...
Section 12 of the DPA provides for the following criteria for
...
(f) The proc essing is necessary for the purposes of the
...
fundamental rights and freedoms of t he data subject which

require protection under the Philippine Constitution

In order for Complain an t to secure a court order, there must

necessarily first be a c ourt proceeding. However, before there can be
...
Section 1 3 of the DPA expressly prohibits the processing of
...
of natural or le gal persons in court proceedings, or the
...
In the case of N PC 17 -018 dated 15 July 2019 , this Commission

held that “processing as ne cessary for the establishment of legal
...
the cle ar letter of the law as well. After all, the very idea of

“establishment … of legal claims” presupposes that there is still no NPC 19-653
...
This Commission in t he same case went on further and held that:
...
of legal claims” consistent with the general princip les of
...
13(f) by the Respondent is considered as le gitimate interest pursuant
...
by a third p arty or parties to whom the data is disclosed, except where

such interests are overridden by fundamental rights and freedoms of

> 3CID Case No. 17 -K-003 dated 19 November 2019 and NPC 18 -135 dated 06 August 2020 NPC 19-653
> BGM v.IPP.
> Page 8of 10
> 5th Floor, Delegation Building, PICC Complex , Pasay City 1307
> URL: http://privacy.gov.ph Email Address: info@privacy.gov.ph
...
be evaluated on a cas e to case basis and must always be subject to the
...
IRR, the process ing of information shall be adequate, relevant,
...
As established above , th e Respondent violated the

Complainant’s right to access which is considered as a violation of the

DPA 8. The Supreme Court has also clarified that no actual present loss
...
or where there has been a b reach of contract and no substantial
...
the Complainant in the total amount of F orty Thousand (P40,000)

Pesos.

WHEREFORE, all premises considered, Responden t IPP . is

hereby ORDERED to furnish the C omplainant BGM the name of the
...
of compliance that it complied with the orders of the Commission

within ten (10) days from the receipt of th is Resolution .
